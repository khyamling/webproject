...
//Strong liaison with industry; Offering courses through application of ICT. 
 ...
 $sql  = "SELECT * FROM  eq5page WHERE email='$UID' and appn='$nappn' ";
...
if( $num_rows > 0)
{
 $sql="UPDATE eq5page SET  Page5= '$Page5', Page6='$Page6', Page7='$Page7', Page8='$Page8',Page11='$Page11', Page12='$Page12',
...
$sql = "insert into eq5page values('$Page5', '$Page6', '$Page7', '$Page8','$Page11', '$Page12', '$Page17',
...
$sql  = "SELECT * FROM  eq5 WHERE email='$UID' and appn='$nappn' ";
	//tmt->execute(array(":emailI=>$email));
...
//update eq5
$sql="UPDATE eq5  SET  ph1='$ph1', ph2='$ph2', ph3='$ph3', ph4='$ph4', ph5='$ph5', ph6='$ph6', ph7='$ph7', ph8='$ph8',
...
F51='$F51', F52='$F52', F53='$F53', F54='$F54'  WHERE appn='$nappn' ";
...
<textarea name="BInternational"  maxlength="1000" style="width: 800px; height: 50px;" rows="" cols="200"  > <?php echo $BInternational; ?> </textarea> 
    ...
    <textarea  style="width: 800px; height: 50px;"rows="4" cols="1000" name="patents" type="text" maxlength="150" size="25" >
         <?php echo $patents; ?>
    </textarea>
<hr>      
