...
if($result1!=null )
{      
   } else{ $usercredit = mysqli_real_escape_string($link, $_POST['usercredit']);
...
<hr>
<center>   
   <input type="submit" id="btn1" formaction="verifiedit1.php" value="Calculate Credit" name="SubmitButton"> </center>
</form>
