...
if( $num_rows > 0)
{
 $sql="UPDATE eq4page SET  Page5= '$Page5', Page6='$Page6', Page7='$Page7', Page8='$Page8',Page11='$Page11', Page12='$Page12',
...
asstprof='$asstprof',  assoprofexp='$assoprofexp',
...
<p width="80%" style="width:80%">   <b>
 ...
 <hr>    
   <!--  <b> Two experiments or computational projects added to teaching laboratories.</b><br><br>
    <textarea name="lab" style="width: 800px; height: 50px;" rows=""  maxlength="1000" cols="500"  ><?php echo $_POST['lab']; ?></textarea> 
