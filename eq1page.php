...
ErrorText= "";
if ( ( form.Page8[0].checked == false ) && ( form.Page8[1].checked == false ) && ( form.Page8[2].checked == false ))
{
alert ( "Please choose your Gender:" );
return false;
}
if ( ( form.Page11[0].checked == false ) && ( form.Page11[1].checked == false ))
{
alert ( "Please choose your Marital Status:" );
return false;
}
if ( ( form.Page12[0].checked == false ) && ( form.Page12[1].checked == false ) && ( form.Page12[2].checked == false )&& ( form.Page12[3].checked == false ))
{
...
$(function() {
 ...
 <tr>
     ...
     <td>
         <input type="text" maxlength="150" size="50" maxlength="120" name="Page5" value="" >
         </td>
        ...
        <td>
            <input name="Page6" maxlength="150" type="text" maxlength="100" size="25" >
...
<tr ><td> Address Line1 </td> <td><input type="text" name="Page22" value="" size="40" maxlength="150" /> </td></tr>
...
<tr><td >      City  </td> <td>  <input type="text" name="Page25" value="" size="40" maxlength="100" />  </td> </tr> 
<tr><td >      Pin Code</td> <td>  <input type="text" name="Page26" value="" size="40" maxlength="10" />  </td> </tr>
<tr><td >     State </td> <td>  <input type="text" name="Page27" value="" size="40" maxlength="100" /></td> </tr>
...
<table CELLPADDING="5" cellspacing="10">
    ...
    <tr>  <td>   Email</td> <td><input type="text" name="Page37" value="" size="40" maxlength="150"/></td></tr>
            ...
            <td>
                ...
                <input type="text" id="start_dt" class='datepicker' maxlength="20" size='15'  name="Page38" >  
     </td>
     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td align=""> &nbsp;&nbsp; <b> 3 &nbsp;&nbsp;(b) Nationality  </b></td>  
    
     <td>
         <input type="text" name="Page41" maxlength="20" value="" >
     </td>
        </tr>
               </table>
...
<hr align="left"  >      
  ...
  <table>
        ...
        <td>Semester- <br> wise Marks (if relevant, <br> separated by semi-colon)  </td>
    </tr>
    <tr >
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e19"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
   ...
   <option value="1946">1946</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e29"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
</tr>
    <tr>
    ...
    <option value="1939">1939</option>
       ...
       <!--for pecentage -->
        ...
        <td><input type="text" name="e39"  maxlength="50"  value=""  pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on" style="width:100px;" ></td>
    </tr>
    <tr>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e49"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
    </tr>
    <tr>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e59"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
    </tr>
    <tr>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e69"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
    </tr>
    <tr>
   ...
   <option value="1946">1946</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e79"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
    </tr>
    <tr>
    ...
    <option value="1939">1939</option>
       ...
       <!--for pecentage -->
         ...
         <!--for pecentage -->
        <td><input type="text" name="e88" id="e88" maxlength="10"  value="" style="width:80px;" ></td>
        <td><input type="text" name="e89"  maxlength="50"  value=""  pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on" style="width:100px;" ></td>
    </tr>
      <tr>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e99"  maxlength="50"  value=""  pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on" style="width:100px;" ></td>
    </tr>
      <tr>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" maxlength="20" name="e105" style="width:120px;" ></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="e108" id="e108" maxlength="10"  value="" style="width:80px;" ></td>
        <td><input type="text" name="e109"  maxlength="50"  value="" pattern="[0-9]{3}((;)[0-9]{3})*" title="pattern is like this 3-digit followed by semicolon again followed by 3-digit and so on"  style="width:100px;" ></td>
    </tr>
    </table>
  <hr>
 ...
 <table style="table-layout: fixed;" cellpadding="1" cellspacing="" >
                <tr >
                  ...
                  <td>Institute/University</td>
                    ...
                    <td><textarea rows="1" cols="30" maxlength="500" input type="text" name="ph1"  id="message" placeholder="Thesis Title" ></textarea> </td> 
                    <td>
                        <input type="text" maxlength="20" id="datepicker"  name="ph2"  style="width:80px;"  >   </td> 
                    <td> 
                        <input type="text" maxlength="20" id="datepicker1"  name="ph3" style="width:80px;" >    </td> 
                    <td ><input type="text" maxlength="150" name="ph4" class="form-control" size="40" > </td> 
                    <td><input type="text" maxlength="150" name="ph5" class="form-control" size="30" > </td> 
                    <td align='center'><select name="ph6"  style="width:140px;" >
                            <option> -Select- </option>
                            <option value="Full Time">Full Time </option>
                                   <option value="Part Time">Part Time </option></select> </td> 
                                   <td><input type="text" maxlength="150"   name="ph7"  style="width:100px;"  >  </td> 
                                   <td><input type="text" maxlength="20" id="datepicker3"  name="ph8"  style="width:100px;"  ></td> 
                </tr>
            </table> 
 <hr> 
...
<td align='center'><input type="text" maxlength="10" name="nt26" class="form-control" size="10"  style="width:100px;"> </td> 
    ...
    <option value="1939">1939</option>
                    ...
                    <td align='center'><input type="text" maxlength="10" name="nt56" class="form-control" size="10"  style="width:100px;"> </td> 
                               ...
                               <hr>
                               <p align="center">        <input type="submit" id="btn1" formaction="eq11page.php" value="Save Progress" name="previous" onClick="ValidateForm(this.form)">               </p>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
     ...
     <br><br>                      <table>
       ...
       <td align="left">
        ...
        <td>
          <input name="teachingexp" maxlength="150" type="text"  size="25" />
       ...
       <td>&nbsp;&nbsp;&nbsp;</td>
        <td>
          <input name="researchexp" maxlength="150" type="text"  size="25" />
    ...
    <option value="1939">1939</option>
	    ...
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
               ...
               <hr align="left" > 
<p><b>14. Research guidance (upload relevant document)</b> </p>
...
<b>15. a. Publication details - No. of Papers </b> 
   ...
   <tr> 
    ...
    <hr align="left" >   
              <b>15. b. Provide details of your 4 best SCI/SCOPUS/SSCI indexed journal papers.<br><br> 
...
<hr>
 ...
 <b> 15.c. Details of all other publications can be added through the 'Publication Details' Tab. </b>
    ...
    <br>
                            ...
                            <textarea  maxlength="1000" style="width: 800px; height: 50px;"rows="4" cols="100" name="patents" type="text" maxlength="200" size="25" ></textarea>
                        <hr align="left" >      
