...
<style>
 ...
 <form action="rulesinserteq5.php" method="post" name="f1" >
      <table  rule="rows">
          <tr> <br><br><br>
...
<tr> <td>   Number of semesters the Dept. level committee positions was held  </td> 
 ...
 <hr>
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p>  <b>10. Workshops/FDP/Short term courses of minimum 05 working days duration offered as coordinator or convenor - Number (since last promotion) (Upload the certificate):</b> </p></tr>
...
<td> <input type="text" maxlength="100" size="10" id="nexap1" name="nexap1" required style="width:100px;"><td> </tr>
    ...
    <hr>
        ...
        <center>  <input type="submit" id="btn1" formaction="rulesinserteq5.php" value="calculate Credit" name="save"> </center>
