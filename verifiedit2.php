 ...
 $link = mysqli_connect("localhost", "root", "123html2pdf", "employment");
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4scr']);
    ...
    $status1="N";
     ...
     $sql  = "SELECT * FROM  newrules2src WHERE appn='$vapn' ";
     $result =  mysqli_query($link, $sql);
     $num_rows = mysqli_num_rows($result);
    //echo $num_rows;
if($num_rows > 0)
{
    $sql="UPDATE newrules2src  SET name='$name', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
{    
$sql = "insert into newrules2src values('$name', '$loneproj', '$teamproj', '$coproj', '$patgrant', '$consult', '$loneguide',
...
<center>   <input type="submit" id="btn1" formaction="creditverify2.php" value="Edit" name="Submit">  <input type="submit" id="btn1" formaction="creditsubmit2.php" value="Submit" name="Submit">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
