  ...
  <tr>              <tr>                    <td> <textarea name="pd51" rows="1" cols="30" readonly><?php echo $row1['pd51']; ?></textarea>                    
    ...
    if($row['examination1']!="")    {
        ?>
                    ...
                    <td><textarea rows="1" cols="50" val="" readonly input type="text" name="nt11"  id="message" placeholder="Examination"> <?php echo $row['examination1']; ?> </textarea> </td> 
    ...
    if($row['examination2']!="")    {
        ?>
                    ...
                    <td><textarea rows="1" cols="50" val="" readonly input type="text" name="nt11"  id="message" placeholder="Examination"> <?php echo $row['examination2']; ?> </textarea> </td> 
    ...
    if($row['examination3']!="")    {
        ?>
                    ...
                    <td><textarea rows="1" cols="50" val="" readonly input type="text" name="nt11"  id="message" placeholder="Examination"> <?php echo $row['examination3']; ?> </textarea> </td> 
    ...
    if($row['examination4']!="")    {
        ?>
                    ...
                    <td><textarea rows="1" cols="50" val="" readonly  name="nt11"  id="message" placeholder="Examination"> <?php echo $row['examination4']; ?> </textarea> </td> 
    ...
    if($row['examination5']!="")    {
        ?>
                    ...
                    <td><textarea rows="1" cols="50" readonly val="" input type="text" name="nt11"  id="message" placeholder="Examination"> <?php echo $row['examination5']; ?> </textarea> </td> 
...
<?php
    ...
    if($row1['E21']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E23" onchange="cal1()"  style="width:100px;" value="<?php echo $row1['E23']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E24" onchange="cal1()" style="width:100px;" value="<?php echo $row1['E24']; ?>" readonly></td>
    ...
    if($row1['E31']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E33" onchange="cal2()"  style="width:100px;" value="<?php echo $row1['E33']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E34" onchange="cal2()" style="width:100px;" value="<?php echo $row1['E34']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E41']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E43" onchange="cal3()"  style="width:100px;" value="<?php echo $row1['E43']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E44" onchange="cal3()" style="width:100px;" value="<?php echo $row1['E44']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E51']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E53" onchange="cal4()"  style="width:100px;" value="<?php echo $row1['E53']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E54" onchange="cal4()" style="width:100px;" value="<?php echo $row1['E54']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E61']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E63" onchange="cal5()"  style="width:100px;" value="<?php echo $row1['E63']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E64" onchange="cal5()" style="width:100px;" value="<?php echo $row1['E64']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E71']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E73" onchange="cal6()"  style="width:100px;" value="<?php echo $row1['E73']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E74" onchange="cal6()" style="width:100px;" value="<?php echo $row1['E74']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E81']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E83" onchange="cal7()"  style="width:100px;" value="<?php echo $row1['E83']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E84" onchange="cal7()" style="width:100px;" value="<?php echo $row1['E84']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E91']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E93" onchange="cal8()"  style="width:100px;" value="<?php echo $row1['E93']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E94" onchange="cal8()" style="width:100px;" value="<?php echo $row1['E94']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E101']!="")
    {
      ...
      <tr>
            ...
            <td> <input type="text" id="datepicker14"  name="E103" onchange="cal9()"  style="width:100px;" value="<?php echo $row1['E103']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E104" onchange="cal9()" style="width:100px;" value="<?php echo $row1['E104']; ?>" readonly></td>
...
<hr>      
    ...
    <br>
     <?php
            ...
            {
                ?>
    <textarea  style="width: 800px; height: 50px;"rows="4" cols="100" name="patents" type="text" maxlength="200" size="25" readonly > <?php echo $row1['patents']; ?></textarea>
                       <?php  
}
?>
<hr>      
 ...
 <table style="text-align: center">
        ...
        if($row1['ie11']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie11" value="<?php echo $row1['ie11']; ?>" readonly /></td>
                    <td ><input type="text" name="ie12"  value="<?php echo $row1['ie12']; ?>" readonly /> </td>
        <td><input type="text" name="ie13" value="<?php echo $row1['ie13']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie21']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie21" value="<?php echo $row1['ie21']; ?>" readonly /></td>
                    <td ><input type="text" name="ie22"  value="<?php echo $row1['ie22']; ?>" readonly /> </td>
        <td><input type="text" name="ie23" value="<?php echo $row1['ie23']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie31']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie31" value="<?php echo $row1['ie31']; ?>" readonly /></td>
                    <td ><input type="text" name="ie32"  value="<?php echo $row1['ie32']; ?>" readonly /> </td>
        <td><input type="text" name="ie33" value="<?php echo $row1['ie33']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie41']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie41" value="<?php echo $row1['ie41']; ?>" readonly /></td>
                    <td ><input type="text" name="ie42"  value="<?php echo $row1['ie42']; ?>" readonly /> </td>
        <td><input type="text" name="ie43" value="<?php echo $row1['ie43']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie51']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie51" value="<?php echo $row1['ie51']; ?>" readonly /></td>
                    <td ><input type="text" name="ie52"  value="<?php echo $row1['ie52']; ?>" readonly /> </td>
        <td><input type="text" name="ie53" value="<?php echo $row1['ie53']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie61']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie61" value="<?php echo $row1['ie61']; ?>" readonly /></td>
                    <td ><input type="text" name="ie62"  value="<?php echo $row1['ie62']; ?>" readonly /> </td>
        <td><input type="text" name="ie63" value="<?php echo $row1['ie63']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie71']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie71" value="<?php echo $row1['ie71']; ?>" readonly /></td>
                    <td ><input type="text" name="ie72"  value="<?php echo $row1['ie72']; ?>" readonly /> </td>
        <td><input type="text" name="ie73" value="<?php echo $row1['ie73']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie81']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie81" value="<?php echo $row1['ie81']; ?>" readonly /></td>
                    <td ><input type="text" name="ie82"  value="<?php echo $row1['ie82']; ?>" readonly /> </td>
        <td><input type="text" name="ie83" value="<?php echo $row1['ie83']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie91']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie91" value="<?php echo $row1['ie91']; ?>" readonly /></td>
                    <td ><input type="text" name="ie92"  value="<?php echo $row1['ie92']; ?>" readonly /> </td>
        <td><input type="text" name="ie93" value="<?php echo $row1['ie93']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['ie101']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="ie101" value="<?php echo $row1['ie101']; ?>" readonly /></td>
                    <td ><input type="text" name="ie102"  value="<?php echo $row1['ie102']; ?>" readonly /> </td>
        <td><input type="text" name="ie103" value="<?php echo $row1['ie103']; ?>" readonly /> </td>
...
<table>
    ...
    <br><br><br>
    <textarea name="live" style="width: 800px; height: 50px;"  rows="" cols="200"  readonly><?php echo $row1['live']; ?></textarea>
<hr> 
