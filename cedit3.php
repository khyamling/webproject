...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="edit3.php" method="post" name="f1" >
      <hr>
       <table  rule="rows">
          <tr>
...
<table colspan="10"> 
             ...
             <tr><td> After Masters, not including PhD enrollment period:</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg"  style="width:100px;"  value="<?php echo $row1['nexpg'] ?>" required></td><td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1" value="<?php echo $row1['nexpg1'] ?>" required  style="width:100px;"><td> </tr>
...
<center>   <input type="submit" id="btn1" formaction="edit3.php" value="Calculate Credit" name="SubmitButton">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
