...
if(!$user_home->is_logged_in())
{
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4']);
    ...
    $nexap1 ="";
     ...
     $sql  = "SELECT * FROM  newrules3 WHERE email='$UID' and appn='$nappn' ";
...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="eq3page.php" method="post" name="f1" >
      <hr>
     <table>
          <tr>
...
<tr> <td> Fellow IEEE, INA, FNAE, FNSc </td> 
 ...
 <table colspan="10"> 
         ...
         <tr><td>Duration after PhD:<td> <input type="text" maxlength="100" size="10"  id="nexphd" name="nexphd"  style="width:100px;" value="<?php echo $nexphd ?>" required></td><td> <input type="text" maxlength="100" size="10" id="nexphd1" name="nexphd1"  value="<?php echo $nexphd1 ?>" required style="width:100px;"><td> </tr>
         
         </table> 
 <hr>
       
<!--<br> <b>number of score is </b>: <br>-->
<center>   <input type="submit" id="btn1" formaction="eq3page.php" value="Submit" name="save">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" id="btn1" formaction="rulesinserteq3.php" value="Calculate Credit" name="SubmitButton"> </center>
