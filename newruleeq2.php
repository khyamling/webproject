...
<style>
 ...
 <form action="rulesinserteq2.php" method="post" name="f1" >
      <table  rule="rows">
          <tr> <br><br><br>
 ...
 <table CELLPADDING=10 cellspacing="10" >
     <tr> <p> <b> 1. One external sponsored R & D Projects completed or ongoing/patent granted</b> </p></tr>
...
<tr>
    <td>  Number of semesters the Assstistance warden positions was held  </td>
...
<tr> <td>   Number of semesters the Dept. level committee positions was held  </td> 
 ...
 <hr>
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p>  <b>10. Workshops/FDP/Short term courses of minimum 05 working days duration offered as coordinator or convenor - Number (since last promotion)</b> </p></tr>
<tr> <td> Number of workshops/courses conducted as coordinator or convenor  </td>
 ...
 <hr>     
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p> <b>11. For conducting National programs like GIAN etc., as course coordinator. Program of 2 / 1 week duration(Since last promotion) </b> </p></tr>
...
<table CELLPADDING=10 cellspacing="10">
    <tr>
    <p> <b>14. Establishment of new lab(Since last promotion)</b> </p> </tr>
...
<tr> <td>
 ...
 <table CELLPADDING=10 cellspacing="10">
     <tr> <p>
         <b>  22.Placement percentage(Only for the placement cell officers)-Since last promotion </b> </p> </tr>
 <tr> <td>
...
<table colspan="10"> 
             ...
             <tr><td> After Masters, not including PhD enrollment period:</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg"  style="width:100px;" required></td><td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1" required  style="width:100px;"><td> </tr>
         <tr><td>After Ph.D :<td> <input type="text" maxlength="100" size="10"  id="nexphd" name="nexphd"  style="width:100px;" required></td><td> <input type="text" maxlength="100" size="10" id="nexphd1" name="nexphd1" required style="width:100px;"><td> </tr>
         
         </table>  
 <hr>
        <!--<br> <b>number of score is </b>: <br>-->
        <center>  <input type="submit" id="btn1" formaction="rulesinserteq2.php" value="calculate Credit" name="save"> </center>
