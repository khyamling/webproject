...
if( $row > 0)
{
$newURL="cfadd1.php"; header('Location: '.$newURL);
}
...
<tr>
            <td><input type="text" size="10" maxlength="150" name="E2_111"></td>
            <td><select name="E2_112">
    <option> - Year - </option>
        <!-- <option value="2020">2020</option> -->
        <option value="2019">2019</option>
        <option value="2018">2018</option>
    ...
    <option value="1939">1939</option>
            ...
            <td><input type="text" size="3" maxlength="150" name="E2_113"></td>
            <td><input type="text" size="10" maxlength="150" name="E2_114"></td>
            <td><input type="text" size="15" maxlength="150" name="E2_115"></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
       <tr>
            <td><input type="text" size="10" maxlength="150" name="E2_121"></td>
            <td><select name="E2_122">
    <option> - Year - </option>
        <!-- <option value="2020">2020</option> -->
        <option value="2019">2019</option>
        <option value="2018">2018</option>
    ...
    <option value="1939">1939</option>
            ...
            <td><input type="text" size="3" maxlength="150" name="E2_123"></td>
            <td><input type="text" size="10" maxlength="150" name="E2_124"></td>
            <td><input type="text" size="15" maxlength="150" name="E2_125"></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
       <tr>
            <td><input type="text" size="10" maxlength="150" name="E2_131"></td>
            <td><select name="E2_132">
    <option> - Year - </option>
        <!-- <option value="2020">2020</option> -->
        <option value="2019">2019</option>
        <option value="2018">2018</option>
    ...
    <option value="1939">1939</option>
            ...
            <td><input type="text" size="3" maxlength="150" name="E2_133"></td>
            <td><input type="text" size="10" maxlength="150" name="E2_134"></td>
            <td><input type="text" size="15" maxlength="150" name="E2_135"></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
       <tr>
            <td><input type="text" size="10" maxlength="150" name="E2_141"></td>
            <td><select name="E2_142">
    <option> - Year - </option>
        <!-- <option value="2020">2020</option> -->
        <option value="2019">2019</option>
        <option value="2018">2018</option>
    ...
    <option value="1939">1939</option>
            ...
            <td><input type="text" size="3" maxlength="150" name="E2_143"></td>
            <td><input type="text" size="10" maxlength="150" name="E2_144"></td>
            <td><input type="text" size="15" maxlength="150" name="E2_145"></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
 <tr>
            <td><input type="text" size="10" maxlength="150" name="E2_151"></td>
            <td><select name="E2_152">
    <option> - Year - </option>
        <!-- <option value="2020">2020</option> -->
        <option value="2019">2019</option>
        <option value="2018">2018</option>
    ...
    <option value="1939">1939</option>
            ...
            <td><input type="text" size="3" maxlength="150" name="E2_153"></td>
            <td><input type="text" size="10" maxlength="150" name="E2_154"></td>
            <td><input type="text" size="15" maxlength="150" name="E2_155"></td>
...
<br>
<center>
      <input type="submit" id="btn1" formaction="cfaddd1.php" value="Save Details" name="previous">              
