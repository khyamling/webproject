...
if(!$user_home->is_logged_in())
{
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4']);
    ...
    $nexap1 ="";
     ...
     $sql  = "SELECT * FROM  newrules2 WHERE email='$UID' and appn='$nappn' ";
...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="eq2page.php" method="post" name="f1" >
      <hr>
     <table>
          <tr>
...
<table colspan="10"> 
             ...
             <tr><td> After Masters, not including PhD enrollment period:</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg"  style="width:100px;"  value="<?php echo $nexpg ?>" required></td><td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1" value="<?php echo $nexpg1 ?>" required  style="width:100px;"><td> </tr>
         <tr><td>After Ph.D :<td> <input type="text" maxlength="100" size="10"  id="nexphd" name="nexphd"  style="width:100px;" value="<?php echo $nexphd ?>" required></td><td> <input type="text" maxlength="100" size="10" id="nexphd1" name="nexphd1"  value="<?php echo $nexphd1 ?>" required style="width:100px;"><td> </tr>
         
         </table>  
 <hr>
<!--<br> <b>number of score is </b>: <br>-->
<center>   <input type="submit" id="btn1" formaction="eq2page.php" value="Submit" name="save">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" id="btn1" formaction="rulesinserteq2.php" value="Calculate Credit" name="SubmitButton"> </center>
