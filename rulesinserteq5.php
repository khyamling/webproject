...
if(!$user_home->is_logged_in())
{
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4']);
    ...
    $nexap1 = mysqli_real_escape_string($link, $_POST['nexap1']);
     ...
     $sql  = "SELECT * FROM  newrules5 WHERE email='$UID' and appn='$nappn' ";
...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="eq5page.php" method="post" name="f1" >
      <hr>
     <table>
          <tr>
...
<center>   <input type="submit" id="btn1" formaction="eq5page.php" value="Submit Credit Points" name="save">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" id="btn1" formaction="rulesinserteq5.php" value="Calculate Credit" name="SubmitButton"> </center>
