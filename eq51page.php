...
//Strong liaison with industry; Offering courses through application of ICT. 
 ...
 if( $num_rows > 0)
  {
  $sql="UPDATE eq5page SET  Page5= '$Page5', Page6='$Page6', Page7='$Page7',
...
'$ao1', '$date', '$place','$nappn', '$UID')";
  ...
  if(mysqli_query($link, $sql)){
     ...
     //  echo "Records added successfully eq5page. Eq page 11111";
...
<p align="center" width="80%">        <input  id="btn1" type="submit" formaction="eq51page.php" value="Save Progress" name="previous">               </p>    
 ...
 <hr>
<table>      
<p>  <b>10. Employment Details (Particulars of your past employment in Chronological order starting with current employment - Upload photocopies) </b>
</p>
...
<hr>      
<b> 21. Conferences/Seminars / Workshops Conducted (Last 4 year -Upload photocopies of the certificates)</b>
<table style="text-align: center">
<tr>
        <td>Year</td>
...
<!-- <b>22. Industrial Experience/Interaction (Upload photocopies)  </b> <br><br>
 ...
 <hr> -->
        <b>24. Continuing Education Programmes /Short Term Courses/Workshops/Seminars etc. organized (Since last promotion)(Attach relevant documents)as per Gazette Note 1(4):</b> <br><br>
