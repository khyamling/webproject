...
if($num_rows > 0)
{
    $sql="UPDATE newrules2  SET name='$name', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
{    
$sql = "insert into newrules2 values('$name', '$loneproj', '$teamproj', '$coproj', '$patgrant', '$consult', '$loneguide',
...
<table colspan="10">
             ...
             <tr><td>After Masters (PG) :</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg" value="<?php echo $rowexp['nexpg']; ?>" style="width:100px;" ></td>
                 <td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1" value="<?php echo $rowexp['nexpg1']; ?>" required  style="width:100px;"><td> </tr>
...
<hr>
<table>        <b> 15.c. Details of all other publications can be added through the 'Publication Details' Tab. </b>
...
<b>19. Consultancy Project</b> <br> <br>
...
<table>
   ...
   <p><b>Additional Desirable requirements</b></p>
     ...
     <br> <br>
     <textarea name="sci" style="width: 800px; height: 50px;" rows="" cols="200"  ><?php echo $row1['sci']; ?></textarea>    
<hr align="left" >
