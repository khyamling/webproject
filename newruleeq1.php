...
<style>
 ...
 <form action="rulesinserteq1.php" method="post" name="f1" >
       <table  rule="rows">
          <tr> <br><br><br>
...
<tr> <td>
 ...
 <tr> <td>
    ...
    <hr>
        ...
        <center>  <input type="submit" id="btn1" formaction="rulesinserteq1.php" value="calculate Credit" name="SubmitButton"> </center>
