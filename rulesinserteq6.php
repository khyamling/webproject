...
if(mysqli_query($link, $sql)){
    ...
    $sql  = "SELECT * FROM  profex5 WHERE email='$UID' and appn='$nappn' ";
$result =  mysqli_query($link, $sql);
$num_rows = mysqli_num_rows($result);
if($num_rows > 0)
 {
...
{
    $sql =  "insert into profex5 values('$nappn','$UID', '$tier',  '$nexap', '$nexap1')";
...
?>
        <!--    <br> <br><br> <font size="5"  face="Comic sans MS"  color="Red"> Credit Earned.</font> -->
<?php  // echo $result1.$result3.$result4.$result5.$result7.$result9.$result11.$result13.$result15.$result17.$result18.$result19.$result20.$result21.$result22.$result24.$result26.$result28.$result30.$result32.$result34.$result35.$result37.$result39 ?> 
...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="eq6page.php" method="post" name="f1" >
      <hr>
     <table>
          <tr>
...
<tr> <td> Fellow IEEE, INA, FNAE, FNSc </td> 
 ...
 <table colspan="10"> 
             ...
             <tr><td>Duration after Masters' Degree (Not counting Ph.D enrolment period):</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg"  value="<?php echo $nexpg ?>" style="width:100px;" required></td><td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1"  value="<?php echo $nexpg1 ?>" required  style="width:100px;"><td> </tr>
         <tr><td>Duration after PhD:<td> <input type="text" maxlength="100" size="10"  id="nexphd" name="nexphd"  value="<?php echo $nexphd ?>" style="width:100px;" required></td><td> <input type="text" maxlength="100" size="10" id="nexphd1" name="nexphd1" value="<?php echo $nexphd1 ?>" required style="width:100px;"><td> </tr>
         <tr><td>Experience at the level of Associate Professor in an institute of repute:</td>
<td> 
    
    <select id="tier"  name="tier">
         <option> <?php  if(!($_POST['tier']=="")){ echo $_POST['tier'] ?> 
       <?php } else { ?>- Select - <?php } ?>  </option>
  <option value="3-Tier Position Post">3-Tier Position Post</option>
  <option value="4-Tier Position Post">4-Tier Position Post</option>
</select> </td>
<td>
<input type="text" maxlength="100" size="10"  id="nexap" name="nexap"     value="<?php echo $nexap ?>"  style="width:100px;" required></td>
<td> <input type="text" maxlength="100" size="10" id="nexap1" name="nexap1" value="<?php echo $nexap1 ?>" required style="width:100px;"><td> </tr>
</table> 
    <hr>
<!--<br> <b>number of score is </b>: <br>-->
<center>   <input type="submit" id="btn1" formaction="eq6page.php" value="Submit" name="save">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" id="btn1" formaction="rulesinserteq6.php" value="Calculate Credit" name="SubmitButton"> </center>
