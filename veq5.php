...
<script language="JavaScript" type="text/javascript">
        function GetDays3(){
                ...
                var pickdt = new Date(documfent.getElementById("datepicker21").value);
                var diff_date =  pickdt-dropdt;
                var num_years = diff_date/31536000000;
                var num_months = (diff_date % 31536000000)/2628000000;
                var num_days = ((diff_date % 31536000000) % 2628000000)/86400000;
...
<td align="">
 ...
 <tr>
     ...
     <td> 
       ...
       <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date of Joining to the present post </td><td><input type="text" id="start_dt1"  size='15'  value="<?php echo $row['Page44']; ?>" readonly   name="Page44" />  </td>
       </tr>
 ...
 <hr>        
  ...
  <tr>                    <td> <textarea name="pd41" rows="1" cols="30" readonly><?php echo $row1['pd41']; ?></textarea>                    
    ...
    {
        ?>
  <tr>                    <td> <textarea name="pd51" rows="1" cols="30" readonly><?php echo $row1['pd51']; ?></textarea>                    
                        </td> 
...
<hr>  
     ...
     if($row1['E11']!="")
    {
        ?>
        <tr>
            <td><input type="text" size="30" name="E11" value="<?php echo $row1['E11']; ?>" readonly></td>
            <td><input type="text" size="30" name="E12" value="<?php echo $row1['E12']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E13" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E13']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E14" onchange="cal()" style="width:100px;" value="<?php echo $row1['E14']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E15" style="width:150px;" value="<?php echo $row1['E15']; ?>" readonly></td>
            <td><input type="text" size="10" name="E16"  style="width:100px;" value="<?php echo $row1['E16']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E17"  style="width:100px;" value="<?php echo $row1['E17']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E21']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E21" value="<?php echo $row1['E21']; ?>" readonly></td>
            <td><input type="text" size="30" name="E22" value="<?php echo $row1['E22']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E23" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E23']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E24" onchange="cal()" style="width:100px;" value="<?php echo $row1['E24']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E25" style="width:150px;" value="<?php echo $row1['E25']; ?>" readonly></td>
            <td><input type="text" size="10" name="E26"  style="width:100px;" value="<?php echo $row1['E26']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E27"  style="width:100px;" value="<?php echo $row1['E27']; ?>" readonly></td>
    ...
    if($row1['E31']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E31" value="<?php echo $row1['E31']; ?>" readonly></td>
            <td><input type="text" size="30" name="E32" value="<?php echo $row1['E32']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E33" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E33']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E34" onchange="cal()" style="width:100px;" value="<?php echo $row1['E34']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E35" style="width:150px;" value="<?php echo $row1['E35']; ?>" readonly></td>
            <td><input type="text" size="10" name="E36"  style="width:100px;" value="<?php echo $row1['E36']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E37"  style="width:100px;" value="<?php echo $row1['E37']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E41']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E41" value="<?php echo $row1['E41']; ?>" readonly></td>
            <td><input type="text" size="30" name="E42" value="<?php echo $row1['E42']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E43" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E43']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E44" onchange="cal()" style="width:100px;" value="<?php echo $row1['E44']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E45" style="width:150px;" value="<?php echo $row1['E45']; ?>" readonly></td>
            <td><input type="text" size="10" name="E46"  style="width:100px;" value="<?php echo $row1['E46']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E47"  style="width:100px;" value="<?php echo $row1['E47']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E51']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E51" value="<?php echo $row1['E51']; ?>" readonly></td>
            <td><input type="text" size="30" name="E52" value="<?php echo $row1['E52']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E53" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E53']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E54" onchange="cal()" style="width:100px;" value="<?php echo $row1['E54']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E55" style="width:150px;" value="<?php echo $row1['E55']; ?>" readonly></td>
            <td><input type="text" size="10" name="E56"  style="width:100px;" value="<?php echo $row1['E56']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E57"  style="width:100px;" value="<?php echo $row1['E57']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E61']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E61" value="<?php echo $row1['E61']; ?>" readonly></td>
            <td><input type="text" size="30" name="E62" value="<?php echo $row1['E62']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E63" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E63']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E64" onchange="cal()" style="width:100px;" value="<?php echo $row1['E64']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E65" style="width:150px;" value="<?php echo $row1['E65']; ?>" readonly></td>
            <td><input type="text" size="10" name="E66"  style="width:100px;" value="<?php echo $row1['E66']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E67"  style="width:100px;" value="<?php echo $row1['E67']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E71']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E71" value="<?php echo $row1['E71']; ?>" readonly></td>
            <td><input type="text" size="30" name="E72" value="<?php echo $row1['E72']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E73" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E73']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E74" onchange="cal()" style="width:100px;" value="<?php echo $row1['E74']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E75" style="width:150px;" value="<?php echo $row1['E75']; ?>" readonly></td>
            <td><input type="text" size="10" name="E76"  style="width:100px;" value="<?php echo $row1['E76']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E77"  style="width:100px;" value="<?php echo $row1['E77']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E81']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E81" value="<?php echo $row1['E81']; ?>" readonly></td>
            <td><input type="text" size="30" name="E82" value="<?php echo $row1['E82']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E83" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E83']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E84" onchange="cal()" style="width:100px;" value="<?php echo $row1['E84']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E85" style="width:150px;" value="<?php echo $row1['E85']; ?>" readonly></td>
            <td><input type="text" size="10" name="E86"  style="width:100px;" value="<?php echo $row1['E86']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E87"  style="width:100px;" value="<?php echo $row1['E87']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E91']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E91" value="<?php echo $row1['E91']; ?>" readonly></td>
            <td><input type="text" size="30" name="E92" value="<?php echo $row1['E92']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E93" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E93']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E94" onchange="cal()" style="width:100px;" value="<?php echo $row1['E94']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E95" style="width:150px;" value="<?php echo $row1['E95']; ?>" readonly></td>
            <td><input type="text" size="10" name="E96"  style="width:100px;" value="<?php echo $row1['E96']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E97"  style="width:100px;" value="<?php echo $row1['E97']; ?>" readonly></td>
...
<?php
    ...
    if($row1['E101']!="")
    {
      ...
      <tr>
            <td><input type="text" size="30" name="E101" value="<?php echo $row1['E101']; ?>" readonly></td>
            <td><input type="text" size="30" name="E102" value="<?php echo $row1['E102']; ?>" readonly> </td>
            <td> <input type="text" id="datepicker14"  name="E103" onchange="cal()"  style="width:100px;" value="<?php echo $row1['E103']; ?>" readonly /> </td>
            <td><input type="text"  id="datepicker15" name="E104" onchange="cal()" style="width:100px;" value="<?php echo $row1['E104']; ?>" readonly></td>
            <td><input type="text" class="textbox" id="numdays" name="E105" style="width:150px;" value="<?php echo $row1['E105']; ?>" readonly></td>
            <td><input type="text" size="10" name="E106"  style="width:100px;" value="<?php echo $row1['E106']; ?>" readonly> </td>
            <td><input type="text" size="10" name="E107"  style="width:100px;" value="<?php echo $row1['E107']; ?>" readonly></td>
...
<hr>      <p>
   ...
   <b>13. Subjects Taught (Last 4 years), Additional Subjects may be added through "Subjects Taught" Tab.</b> 
   <br><br>
<table  width="60%" style="text-align: center">
<thead>
    ...
    <table>
        ...
        <td> Completed (Guided Joint): </td>  <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
         ...
         <?php
             ...
             ?>
        <td>
            <input name="phdcomplete" type="text" maxlength="100" size="25" value="<?php echo $row1['phdcomplete']; ?>" readonly/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <?php
             }
        ...
        <?php
             ...
             ?>
        <td>
            <input name="phdongoing" type="text" maxlength="100" size="25" value="<?php echo $row1['phdongoing']; ?>" readonly/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
             <?php
             }
        ...
        <td align="right">
         ...
         <?php
             ...
             ?>
        <td>
            <input name="cj1" type="text" maxlength="100" size="25" value="<?php echo $row1['cj1']; ?>" readonly/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
         <?php
             }
        ...
        <td align="right">
          ...
          <?php
             ...
             ?>
        <td>
            <input name="oj1" type="text" maxlength="100" size="25"  value="<?php echo $row1['oj1']; ?>" readonly/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
         <?php
             }
       ...
       <td align="right">
         ...
         <?php
             ...
             ?>
        <td>
            <input name="pgcomplete" type="text" maxlength="100" size="25" value="<?php echo $row1['pgcomplete']; ?>" readonly/>
       ...
       <td align="right">
         ...
         <?php
             ...
             ?>
        <td>
            <input name="pgongoing" type="text" maxlength="100" size="25" value="<?php echo $row1['pgongoing']; ?>" readonly/>
        ...
        <td align="right">
          ...
          <?php
             ...
             ?>
        <td>
            <input name="cj2" type="text" maxlength="100" size="25"  value="<?php echo $row1['cj2']; ?>" readonly/>
        ...
        <td align="right">
          <p>P.G.</p>
           ...
           <?php
             ...
             ?>
        <td>
            <input name="oj2" type="text" maxlength="100" size="25"  value="<?php echo $row1['oj2']; ?>" readonly/>
...
?>
 ...
 <br>
    ...
    <?php
            ...
            {
                ?>
         <textarea name="patents" style="width: 800px; height: 50px;"rows="4" cols="100" readonly><?php echo $row1['patents']; ?></textarea>
  ...
  <hr>      
    ...
    <br><br>
       ...
       <?php
        ...
        <tr>
          <td><input type="text" size="20" name="E4_11" value="<?php echo $row1['E4_11']; ?>" readonly /></td>
            <td><input type="text" size="20" name="E4_12" value="<?php echo $row1['E4_12']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_13" value="<?php echo $row1['E4_13']; ?>" readonly /> </td>
            <td><input type="text" size="8" name="E4_14" value="<?php echo $row1['E4_14']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_15" value="<?php echo $row1['E4_15']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_16" value="<?php echo $row1['E4_16']; ?>" readonly /></td>
        ...
        <?php
           ...
           ?>
        <tr>
          <td><input type="text" size="20" name="E4_21" value="<?php echo $row1['E4_21']; ?>" readonly /></td>
            <td><input type="text" size="20" name="E4_22" value="<?php echo $row1['E4_22']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_23" value="<?php echo $row1['E4_23']; ?>" readonly /> </td>
            <td><input type="text" size="8" name="E4_24" value="<?php echo $row1['E4_24']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_25" value="<?php echo $row1['E4_25']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_26" value="<?php echo $row1['E4_26']; ?>" readonly /></td>
        ...
        <?php
           ...
           ?>
        <tr>
          <td><input type="text" size="20" name="E4_31" value="<?php echo $row1['E4_31']; ?>" readonly /></td>
            <td><input type="text" size="20" name="E4_32" value="<?php echo $row1['E4_32']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_33" value="<?php echo $row1['E4_33']; ?>" readonly /> </td>
            <td><input type="text" size="8" name="E4_34" value="<?php echo $row1['E4_34']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_35" value="<?php echo $row1['E4_35']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_36" value="<?php echo $row1['E4_36']; ?>" readonly /></td>
        ...
        <?php
           ...
           ?>
        <tr>
          <td><input type="text" size="20" name="E4_41" value="<?php echo $row1['E4_41']; ?>" readonly /></td>
            <td><input type="text" size="20" name="E4_42" value="<?php echo $row1['E4_42']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_43" value="<?php echo $row1['E4_43']; ?>" readonly /> </td>
            <td><input type="text" size="8" name="E4_44" value="<?php echo $row1['E4_44']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_45" value="<?php echo $row1['E4_45']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_46" value="<?php echo $row1['E4_46']; ?>" readonly /></td>
	    ...
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
         ...
         <?php
           ...
           ?>
        <tr>
          <td><input type="text" size="20" name="E4_51" value="<?php echo $row1['E4_51']; ?>" readonly /></td>
            <td><input type="text" size="20" name="E4_52" value="<?php echo $row1['E4_52']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_53" value="<?php echo $row1['E4_53']; ?>" readonly /> </td>
            <td><input type="text" size="8" name="E4_54" value="<?php echo $row1['E4_54']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_55" value="<?php echo $row1['E4_55']; ?>" readonly /> </td>
            <td><input type="text" size="10" name="E4_56" value="<?php echo $row1['E4_56']; ?>" readonly /></td>
...
<b>19. Consultancy Project (in last 4 years)</b> <br> <br>
        ...
        <tbody>
           ...
           ?>
        <tr>
            <td><input type="text" size="20" name="F11" value="<?php echo $row1['F11']; ?>" readonly /></td>
            <td><input type="text" size="20" name="F12" value="<?php echo $row1['F12']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F13" value="<?php echo $row1['F13']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F14" value="<?php echo $row1['F14']; ?>" readonly /> </td>
        ...
        <?php
           ...
           ?>    
         <tr>
            <td><input type="text" size="20" name="F21" value="<?php echo $row1['F21']; ?>" readonly /></td>
            <td><input type="text" size="20" name="F22" value="<?php echo $row1['F22']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F23" value="<?php echo $row1['F23']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F24" value="<?php echo $row1['F24']; ?>" readonly /> </td>
        ...
        <?php
           ...
           ?>    
         <tr>
            <td><input type="text" size="20" name="F31" value="<?php echo $row1['F31']; ?>" readonly /></td>
            <td><input type="text" size="20" name="F32" value="<?php echo $row1['F32']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F33" value="<?php echo $row1['F33']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F34" value="<?php echo $row1['F34']; ?>" readonly /> </td>
        ...
        <?php
           ...
           ?>    
         <tr>
            <td><input type="text" size="20" name="F41" value="<?php echo $row1['F41']; ?>" readonly /></td>
            <td><input type="text" size="20" name="F42" value="<?php echo $row1['F42']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F43" value="<?php echo $row1['F43']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F44" value="<?php echo $row1['F44']; ?>" readonly /> </td>
        ...
        <?php
           ...
           ?>    
         <tr>
            <td><input type="text" size="20" name="F51" value="<?php echo $row1['F51']; ?>" readonly /></td>
            <td><input type="text" size="20" name="F52" value="<?php echo $row1['F52']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F53" value="<?php echo $row1['F53']; ?>" readonly /> </td>
            <td><input type="text" size="20" name="F54" value="<?php echo $row1['F54']; ?>" readonly /> </td>
...
<hr>      
 ...
 <hr> 
        <b>22. Continuing Education Programmes /Short Term Courses/Workshops/Seminars etc. organized (Last 4 years):</b> <br><br>
   ...
   <tr>
        ...
        if($row1['fa11']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="fa11" value="<?php echo $row1['fa11']; ?>" readonly /></td>
                    <td ><input type="text" name="fa12"  value="<?php echo $row1['fa12']; ?>" readonly /> </td>
        <td><input type="text" name="fa13" value="<?php echo $row1['fa13']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa21']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="fa21" value="<?php echo $row1['fa21']; ?>" readonly /></td>
                    <td ><input type="text" name="fa22"  value="<?php echo $row1['fa22']; ?>" readonly /> </td>
        <td><input type="text" name="fa23" value="<?php echo $row1['fa23']; ?>" readonly /> </td>
    ...
    <tr>
        <td><input type="text" name="fa31" value="<?php echo $row1['fa31']; ?>" readonly /></td>
                    <td ><input type="text" name="fa32"  value="<?php echo $row1['fa32']; ?>" readonly /> </td>
        <td><input type="text" name="fa33" value="<?php echo $row1['fa33']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa41']!="")
            {
                    ?>
    <tr>
       <td><input type="text" name="fa41" value="<?php echo $row1['fa41']; ?>" readonly /></td>
                    <td ><input type="text" name="fa42"  value="<?php echo $row1['fa42']; ?>" readonly /> </td>
        <td><input type="text" name="fa43" value="<?php echo $row1['fa43']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa51']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="fa51" value="<?php echo $row1['fa51']; ?>" readonly /></td>
                    <td ><input type="text" name="fa52"  value="<?php echo $row1['fa52']; ?>" readonly /> </td>
        <td><input type="text" name="fa53" value="<?php echo $row1['fa53']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa61']!="")
            {
                    ?>
    <tr>
       <td><input type="text" name="fa61" value="<?php echo $row1['fa61']; ?>" readonly /></td>
                    <td ><input type="text" name="fa62"  value="<?php echo $row1['fa62']; ?>" readonly /> </td>
        <td><input type="text" name="fa63" value="<?php echo $row1['fa63']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa71']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="fa71" value="<?php echo $row1['fa71']; ?>" readonly /></td>
                    <td ><input type="text" name="fa72"  value="<?php echo $row1['fa72']; ?>" readonly /> </td>
        <td><input type="text" name="fa73" value="<?php echo $row1['fa73']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa81']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="fa81" value="<?php echo $row1['fa81']; ?>" readonly /></td>
                    <td ><input type="text" name="fa82"  value="<?php echo $row1['fa82']; ?>" readonly /> </td>
        <td><input type="text" name="fa83" value="<?php echo $row1['fa83']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa91']!="")
            {
                    ?>
    <tr>
       <td><input type="text" name="fa91" value="<?php echo $row1['fa91']; ?>" readonly /></td>
                    <td ><input type="text" name="fa92"  value="<?php echo $row1['fa92']; ?>" readonly /> </td>
        <td><input type="text" name="fa93" value="<?php echo $row1['fa93']; ?>" readonly /> </td>
    ...
    <?php
            ...
            if($row1['fa101']!="")
            {
                    ?>
    <tr>
        <td><input type="text" name="fa101" value="<?php echo $row1['fa101']; ?>" readonly /></td>
                    <td ><input type="text" name="fa102"  value="<?php echo $row1['fa102']; ?>" readonly /> </td>
        <td><input type="text" name="fa103" value="<?php echo $row1['fa103']; ?>" readonly /> </td>
 ...
 <hr> 
 <b>23. Experience in Administrative Positions, Curriculum and Lab Development,  Student Welfare, Professional and Outreach Activities -Non remunerative  (upload relevant document(s))</b> <br><br>
...
<hr> </div>
        ...
        <b>27. Please indicate how in your opinion you can contribute to NITK's growth. (upload relevant document) <br>  <br>
     <textarea style="width: 800px; height: 50px;" name="ao1" placeholder="Limited to 250 words"   readonly /><?php echo $row['ao1']; ?>
    </textarea>
...
<p width="80%" style="width:80%">   <b> 
    ...
    <!-- <b> Two experiments or computational projects added to teaching laboratories.</b><br><br>
     <textarea name="lab" style="width: 800px; height: 50px;" rows="" cols="200" readonly ><?php echo $row1['lab']; ?></textarea>
    
     <hr> -->
      <b> Strong liaison with industry; Offering courses through application of ICT. </b>             
     <br> <br>
     <textarea name="industry" style="width: 800px; height: 50px;"  rows="" cols="200"  readonly><?php echo $row1['industry']; ?></textarea>
    
     <hr>
<p width="80%" style="width:80%">   
 <b> 28. </b>I hereby declare that the entries in this form are true to the best of my knowledge and belief. I understand that my Candidature will be cancelled if any of the information is found to be false or incorrect. Further, if selected, I will abide by
...
<tr>
    ...
    <table  align="center" width="40%"> 
        <tr>
<td> <p align="center" width="80%"> <input id="btn1" type="submit"  value="Close Applciation" name="previous"> <td></tr>
