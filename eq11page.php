 ...
 */
  ...
  // database of 15. a. publication details
    ...
    //database for 1.academic-dactoral degree(Ph.D details).
   $nappn=$_POST['nappn'];
   ...
   // database of 16. Books/chapter
    ...
    //database of 23. continuing education programmes
       ...
       //database of 28. please indicate how in your opinion 
        ...
        $sql  = "SELECT * FROM  eq1page WHERE email='$UID' and appn='$nappn' ";
...
else
{
   ...
   $sql = "insert into eq1page values('$Page5', '$Page6', '$Page7', '$Page8','$Page11', '$Page12', '$Page17', '$Page18', '$Page19','$Page22', '$Page23', '$Page24', '$Page25', '$Page26', '$Page27', '$Page28', '$Page29','$Page30', '$Page31', '$Page32', '$Page33', '$Page34', '$Page35', '$Page36', '$Page37', '$Page38', '$Page41', '$Page42', '$Page43', '$Page44', '$Page45', '$Page46', '$Page47', '$Page48', '$Page49',
...
'$ao1', '$date', '$place','$nappn', '$UID' )";
 ...
 $sql  = "SELECT * FROM  eq1 WHERE email='$UID' and appn='$nappn' ";
	//tmt->execute(array(":emailI=>$email));
...
{
///updating eq1 table 
 $sql="UPDATE eq1  SET  ph1='$ph1', ph2='$ph2', ph3='$ph3', ph4='$ph4', ph5='$ph5', ph6='$ph6', ph7='$ph7', ph8='$ph8',
...
'$E3_41', '$E3_42', '$E3_43', '$E3_44', '$E3_45', '$E3_46', '$E3_47', '$nappn', '$UID')";
...
<td><input type="text" id="e67" maxlength="11" name="e67" onChange="perc6()" value="<?php echo $_POST['e67']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e68" id="e68" maxlength="10"  value="<?php echo $_POST['e68']; ?>" ></td>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
               ...
               <hr align="left" > 
                    <p align="center">        <input type="submit" id="btn1" formaction="eq11page.php" value="Save Progress" name="previous">               </p>
                   <hr align="left" >      <p>
...
<tr> For the current employment, please enter the "Date of leaving"
field as the faculty recruitment application form submission deadline
date. </tr> 
<br> <br>
</table>
    ...
    <tbody>
        <tr>
            <td><input type="text" size="30" name="E11" value="<?php echo $E11; ?>"  maxlength="150" /></td>
            <td><input type="text" size="30" name="E12" value="<?php echo $E12; ?>"  maxlength="150" /></td>
            <td> <input type="text" id="datepicker14"  name="E13" onchange="cal()"  style="width:100px;" value="<?php echo $E13; ?>"  maxlength="150" /> </td>
            <td><input type="text"  id="datepicker15" name="E14" onchange="cal()" style="width:100px;" value="<?php echo $E14; ?>"   maxlength="150"/></td>
            <td><input type="text" class="textbox" id="numdays" name="E15" style="width:150px;" value="<?php echo $E15; ?>"   maxlength="150" /></td>
            <td><input type="text" size="10" name="E16"  style="width:100px;" value="<?php echo $E16 ?>"  maxlength="150" /></td>
            <td><input type="text" size="10" name="E17"  style="width:100px;" value="<?php echo $E17; ?>"  maxlength="150" /></td>
        ...
        <tr>
            <td><input type="text" size="30" name="E21" value="<?php echo $E21; ?>"  maxlength="150" /></td>
            <td><input type="text" size="30" name="E22" value="<?php echo $E22; ?>"  maxlength="150" /></td>
          <td><input type="text"  id="datepicker16" name="E23" onchange="cal1()"  style="width:100px;" value="<?php echo $E23; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker17"  name="E24" onchange="cal1()" style="width:100px;" value="<?php echo $E24; ?>"  maxlength="150" /></td>
            <td><input type="text" class="textbox" id="numdays1" name="E25" style="width:150px;" value="<?php echo $E25; ?>"  maxlength="150" /></td>
            <td><input type="text" size="10" name="E26"  style="width:100px;" value="<?php echo $E26; ?>"  maxlength="150"  /></td>
            <td><input type="text" size="10" name="E27"  style="width:100px;" value="<?php echo $E27; ?>"  maxlength="150" /></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
       ...
       <tr>
              <tr>
            <td><input type="text" size="30" name="E31" value="<?php echo $E31; ?>"  maxlength="150" /></td>
            <td><input type="text" size="30" name="E32" value="<?php echo $E32; ?>"  maxlength="150" /></td>
            <td> <input type="text" id="datepicker18"  name="E33" onchange="cal2()"  style="width:100px;" value="<?php echo $E33; ?>"  maxlength="150" /> </td>
            <td><input type="text"  id="datepicker19" name="E34" onchange="cal2()" style="width:100px;" value="<?php echo $E34; ?>"  maxlength="150" /> </td>
            <td><input type="text" class="textbox" id="numdays2" name="E35" style="width:150px;" value="<?php echo $E35; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E36"  style="width:100px;" value="<?php echo $E36; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E37"  style="width:100px;" value="<?php echo $E37; ?>"  maxlength="150" /> </td>
        ...
        <tr>
            <td><input type="text" size="30" name="E41" value="<?php echo $E41; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="30" name="E42" value="<?php echo $E42; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker20" name="E43" onchange="cal3()"  style="width:100px;"value="<?php echo $E43 ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker21" name="E44" onchange="cal3()" style="width:100px;" value="<?php echo $E44; ?>"  maxlength="150" /></td>
            <td><input type="text" class="textbox" id="numdays3" name="E45" style="width:150px;" value="<?php echo $E45; ?>"   maxlength="150" /> </td>
            <td><input type="text" size="10" name="E46"  style="width:100px;" value="<?php echo $E46; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E47"  style="width:100px;" value="<?php echo $E47; ?>"  maxlength="150" /> </td>
        ...
        <tr>
            <td><input type="text" size="30" name="E51" value="<?php echo $E51; ?>"  maxlength="150"  /> </td>
            <td><input type="text" size="30" name="E52" value="<?php echo $E52; ?>"  maxlength="150"  /> </td>
            <td><input type="text" id="datepicker22"  name="E53" onchange="cal4()"  style="width:100px;" value="<?php echo $E53; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker23"  name="E54" onchange="cal4()"  style="width:100px;" value="<?php echo $E54; ?>"   maxlength="150" /> </td>
            <td><input type="text" class="textbox" id="numdays4" name="E55"  style="width:150px;" value="<?php echo $E55; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E56"  style="width:100px;" value="<?php echo $E56; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E57"  style="width:100px;" value="<?php echo $E57; ?>"  maxlength="150" /> </td>
  
        </tr>

        <tr>
            <td><input type="text" size="30" name="E61" value="<?php echo $E61; ?>"  maxlength="150"  /> </td>
            <td><input type="text" size="30" name="E62" value="<?php echo $E62; ?>"  maxlength="150"  /> </td>
            <td><input type="text" id="datepicker24" name="E63" onchange="cal5()"  style="width:100px;" value="<?php echo $E63; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker25" name="E64" onchange="cal5()"  style="width:100px;" value="<?php echo $E64; ?>"  maxlength="150" /> </td>
            <td><input type="text" class="textbox" id="numdays5" name="E65"  style="width:150px;" value="<?php echo $E65; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E66"  style="width:100px;" value="<?php echo $E66; ?>"   maxlength="150" /> </td>
            <td><input type="text" size="10" name="E67"  style="width:100px;" value="<?php echo $E67; ?>"  maxlength="150" /> </td>
        ...
        <tr>
            <td><input type="text" size="30" name="E71" value="<?php echo $E71; ?>"  maxlength="150"  /> </td>
            <td><input type="text" size="30" name="E72" value="<?php echo $E72; ?>"  maxlength="150" /> </td>
          <td><input type="text"   id="datepicker26" name="E73" onchange="cal6()"  style="width:100px;"  value="<?php echo $E73; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker27"  name="E74" onchange="cal6()"  style="width:100px;" value="<?php echo $E74; ?>"  maxlength="150"  /> </td>
            <td><input type="text" class="textbox" id="numdays6" name="E75"  style="width:150px;" value="<?php echo $E75; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E76"  style="width:100px;" value="<?php echo $E76; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E77"  style="width:100px;" value="<?php echo $E77; ?>"  maxlength="150" /> </td>
         ...
         <tr>
            <td><input type="text" size="30" name="E81" value="<?php echo $E81; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="30" name="E82" value="<?php echo $E82; ?>"  maxlength="150" /> </td>
           <td><input type="text"  id="datepicker28" name="E83" onchange="cal7()"  style="width:100px;" value="<?php echo $E83; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker29" name="E84" onchange="cal7()" style="width:100px;" value="<?php echo $E84; ?>"  maxlength="150" /> </td>
            <td><input type="text" class="textbox" id="numdays7" name="E85" style="width:150px;" value="<?php echo $E85; ?>"   maxlength="150" /> </td>
            <td><input type="text" size="10" name="E86"  style="width:100px;" value="<?php echo $E86; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E87"  style="width:100px;" value="<?php echo $E87; ?>"  maxlength="150" /> </td>
            
            <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
         <tr>
            <td><input type="text" size="30" name="E91" value="<?php echo $E91; ?>"   maxlength="150"/> </td>
            <td><input type="text" size="30" name="E92" value="<?php echo $E92; ?>"   maxlength="150" /> </td>
            <td><input type="text" id="datepicker30" name="E93" onchange="cal8()"  style="width:100px;" value="<?php echo $E93; ?>"   maxlength="150" /> </td>
            <td><input type="text" id="datepicker31"  name="E94" onchange="cal8()"  style="width:100px;" value="<?php echo $E94; ?>"  maxlength="150" /> </td>
            <td><input type="text" class="textbox" id="numdays8" name="E95" style="width:150px;" value="<?php echo $E95; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="10" name="E96"  style="width:100px;" value="<?php echo $E96; ?>"   maxlength="150"/> </td>
            <td><input type="text" size="10" name="E97"  style="width:100px;" value="<?php echo $E97; ?>"  maxlength="150" /> </td>
            
            <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
         <tr>
            <td><input type="text" size="30" name="E101" value="<?php echo $E101; ?>"  maxlength="150" /> </td>
            <td><input type="text" size="30" name="E102" value="<?php echo $E102; ?>"  maxlength="150" /> </td>
            <td><input type="text" id="datepicker32" name="E103" onchange="cal9()"  style="width:100px;" value="<?php echo $E103; ?>"   maxlength="150" /> </td>
            <td><input type="text" id="datepicker33" name="E104" onchange="cal9()"  style="width:100px;" value="<?php echo $E104; ?>"   maxlength="150" /> </td>
            <td><input type="text" class="textbox" id="numdays9" name="E105"  style="width:150px;" value="<?php echo $E105; ?>"  maxlength="150" /></td>
            <td><input type="text" size="10" name="E106"  style="width:100px;" value="<?php echo $E106; ?>"   maxlength="150" /> </td>
            <td><input type="text" size="10" name="E107"  style="width:100px;" value="<?php echo $E107; ?>"  maxlength="150" /> </td>
...
<b>15. a. Publication details - No. of Papers </b> 
   ...
   <tr> 
            ...
            <p>International</p>
                        ...
                        <td>
                        <input name="JInternational" type="text" maxlength="150" size="25" value="<?php echo $_POST['JInternational']; ?>"  />
            ...
            <p>International</p>
                        ...
                        <td>
                        <input name="CInternational" type="text" maxlength="150" size="25" value="<?php echo $_POST['CInternational']; ?>"  />
                ...
                <tr> 
                        ...
                        <p>National</p>
                            ...
                            <td>
                        <input name="JNational" type="text" maxlength="150" size="25" value="<?php echo $_POST['JNational']; ?>"  />
    <!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
                       </td>
                       <td align="left">
                        <p>National</p>
                            ...
                            <td>
                        <input name="CNational" type="text" maxlength="150" size="25" value="<?php echo $_POST['CNational']; ?>"  />
    <!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
                       </td>
                    </tr>    
    ...
    <option value="1939">1939</option>
	    ...
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
                                      ...
                                      <hr align="left" >    
                 <p align="center">        <input type="submit" id="btn1" formaction="eq12page.php" value="Save Progress" name="previous">               </p>  
                   <hr align="left" >      
...
<table>
    <tr>
<p style="width:80%">   <b> 29. </b>I hereby declare that the entries in this form are true to the best of my knowledge and belief. I understand that my Candidature will be cancelled if any of the information is found to be false or incorrect. Further, if selected, I will abide by
     ...
     <table> <tr>
             <td> <b>  Date: </b></td> <td> 
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><b>Place:</b></td><td> <input type="text" name="place"  maxlength="150"> </td>
    </tr>
