...
$sql="UPDATE newrules6  SET name='$name', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
if(mysqli_query($link, $sql)){
    ...
    $tier = mysqli_real_escape_string($link, $_POST['tier']);
    $nexap = mysqli_real_escape_string($link, $_POST['nexap']);
    $nexap1 = mysqli_real_escape_string($link, $_POST['nexap1']);
    $sql="UPDATE profex5  SET tier='$tier', nexap='$nexap', nexap1='$nexap1' WHERE appn='$nappn'";
...
<table CELLPADDING="5" cellspacing="10">
    ...
    <tr>  <td>   Email</td> <td><input type="text" name="Page37" value="" size="40" maxlength="150"/></td></tr>
            ...
            <td>
                ...
                <input type="text" id="start_dt" class='datepicker' maxlength="20" size='25'  name="Page38" >  
     </td>
     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
   ...
   <tr>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e15"  maxlength="20"  value=""  style="width:120px;"  ></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="e18"  id="e18"  maxlength="10"  value="" style="width:80px;" ></td>
   ...
   <option value="1946">1946</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" maxlength="20"  name="e25"  style="width:120px;"  ></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="e28"  id="e28" maxlength="10"  value="" style="width:80px;" ></td>
    ...
    <option value="1939">1939</option>
       ...
       <!--for pecentage -->
         ...
         <!--for pecentage -->
        <td><input type="text" name="e38"  id="e38" maxlength="10"  value="" style="width:80px;" ></td>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" maxlength="20"  name="e45" style="width:120px;"></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="e48" id="e48" maxlength="10"  value="" style="width:80px;" ></td>
    ...
    <option value="1939">1939</option>
        ...
        <!--for pecentage -->
         ...
         <!--for pecentage -->
         <td><input type="text" name="e58" id="e58"  maxlength="10"  value="" style="width:80px;" ></td>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" maxlength="20"  name="e65" style="width:120px;"></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="e68" id="e68" maxlength="10"  value="" style="width:80px;" ></td>
   ...
   <option value="1946">1946</option>
    ...
    <option value="1939">1939</option>
        ...
        <!--for pecentage -->
         ...
         <!--for pecentage -->
         <td><input type="text" name="e78" id="e78" maxlength="10"  value="" style="width:80px;" ></td>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" maxlength="20"  name="e95" style="width:120px;" ></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="e98" id="e98" maxlength="10"  value="" style="width:80px;" ></td>
...
<table colspan="10"> 
             ...
             <tr><td>Duration after Masters' Degree (Not counting Ph.D enrolment period):</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg"  style="width:100px;" ></td><td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1"   style="width:100px;"><td> </tr>
         <tr><td>Duration after PhD:<td> <input type="text" maxlength="100" size="10"  id="nexphd" name="nexphd"  style="width:100px;" ></td><td> <input type="text" maxlength="100" size="10" id="nexphd1" name="nexphd1"  style="width:100px;"><td> </tr>
         <tr><td>Experience at the level of Assistant Professor(AGP:8000) or equivalent :<td> <input type="text" maxlength="100" size="10"  id="nexap" name="nexap"  style="width:100px;" ></td><td> <input type="text" maxlength="100" size="10" id="nexap1" name="nexap1"  style="width:100px;"><td> </tr>
...
<b>11. Total Experience (Number of Years and/or months)  </b>      
     <br><br>                      <table>
       ...
       <td align="left">
        ...
        <td>
            <input name="teachingexp" type="text"  maxlength="150"  size="25" />
       ...
       <td>&nbsp;&nbsp;&nbsp;</td>
        <td>
          <input name="researchexp" type="text" maxlength="150" size="25" />
   ...
   <td align="right">
        ...
        <td>
          <input name="assoprofexp" type="text" maxlength="150" size="25" />
   ...
   <td align="right">
        ...
        <td>
          <input name="profexp" type="text" maxlength="150" size="25" />
...
<p width="80%" style="width:80%">   <b>
 ...
 <hr>    
    ...
    <textarea name="expcomp" style="width: 800px; height: 50px;" rows=""  maxlength="1000" cols="200"  ></textarea>
    
     <hr>
      <b> Strong liaison with industry; Offering courses through application of ICT. </b>             
     <br> <br>
     <textarea name="respos" style="width: 800px; height: 50px;"  rows="" maxlength="1000" cols="200"  ></textarea>
