 ...
 */
 ...
 $sql="UPDATE newrules3  SET name='$name', dept='$dept', Inst='$Inst', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
 ...
 if(mysqli_query($link, $sql)){
      ...
      //  echo "Updated added successfully. ";
...
<b>11. Total Experience (Number of Years and/or months)  </b>      
    ...
    <td>&nbsp;&nbsp;&nbsp;</td>
       <td align="left">
        ...
        <td>
          <input name="industryexp" type="text" maxlength="100" size="25" maxlength="150"/>
...
<hr><p><b>13. Subjects Taught (Since last promotion)</b> 
   <br><br>
<table  width="60%" style="text-align: center">
 <thead>
...
<hr>                       
<p><b>15. a.  Publication details - No. of Papers </b> 
        <br>     <br>     
 <table>
...
<hr>
 ...
 <b> 15.c. Details of all other publications can be added through the 'Publication Details' Tab. </b>
   ...
   <hr>      
    ...
    <br><br>
                 <textarea name="BInternational" maxlength="1000" style="width: 800px; height: 50px;" rows="" cols="150"  > </textarea> 

        <hr>  
        <br>
         <b>17. Patents(applied or awarded) </b> 
    <br>
<textarea name="patents" style="width: 800px; height: 50px;"rows="4"  maxlength="1000" cols="100" ></textarea>
...
<tr><td >2.&nbsp;&nbsp;&nbsp;<input type="text" style="width: 300px;" maxlength="200" name="pr21"  ></td></tr>
 ...
 <textarea name="expcomp" style="width: 800px; height: 50px;"  rows="" maxlength="1000" cols="200"  ></textarea>
    ...
    <br><br><br>
    <textarea name="live" style="width: 800px; height: 50px;"  rows="" maxlength="1000"  cols="200"  ></textarea>        
<hr> 
