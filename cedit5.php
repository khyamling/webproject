...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="edit5.php" method="post" name="f1" >
      <hr>
     <table  rule="rows">
          <tr>
 ...
 <tr> <td> Amount Earned from Consultancy Projects in Lakhs (2 credit point @ Rs. 5 lakhs)</td>
...
<table colspan="10"> 
         ...
         <tr><td>Experience at the level of Associate Professor (AGP:9000/9500):
...
<center>   <input type="submit" id="btn1" formaction="edit5.php" value="Submit Credit Points" name="SubmitButton">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
