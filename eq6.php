...
$(function() {
  $("#E3_43").autocomplete({
	...
	<li><a href="submit.php">Submit/Print Application</a></li>
		...
		<form action="eq6page.php" method="post" name="f1" onsubmit="return validateform()" >
		   <hr>
		    ...
		    <tr><b>Fill in Essential Qualification Details </b>
		    <hr>
	 ...
	 <br>
	  ...
	  <table style="table-layout: fixed;" cellpadding="1" cellspacing="" >
	     ...
	     <hr>
	     <table>
		 <tr> <b>Fill in Relevant Experience Details</b>
		 <h6><p> Note: 06 years as Professor with AGP of Rs.10,000 or Rs.10,500 in an institute of National importance. </p></h6></tr>
		 <hr>      
	...
	<table colspan="10"> 
		 ...
		 <tr><td>Experience at the level of Professor(AGP:10000 or 10500) in an institute of national importance :<td> <input type="text" maxlength="100" size="10"  id="nexap" name="nexap"  style="width:100px;" required></td><td> <input type="text" maxlength="100" size="10" id="nexap1" name="nexap1" required style="width:100px;"><td> </tr>
		 
		 </table> 
	 <hr>
	 <b> Fill in Other Essential Requirements Details</b>  <h6><p style="width:980px"> Note: 04 Ph.D.s  guided as sole or principal supervisor plus at least one full time resident student continuing. The following during the past six years (i) 4 papers in SCI journal <br> (ii) two high value sponsored or consultancy projects plus one on going; <br> (iii) Academic outreach activity equivalent to three self-financed short-term courses offered as coordinator and main teacher; <br> (iv) Three experiments or computational design projects with added to teaching laboratories. <br>(v) Significant  contribution to institute management through personal initiative in responsible positions. </p></h6>
	    <hr>     
   ...
   <tr>
    ...
    <td ><input type="text" maxlength="150" name="fa63" ></td>
     ...
     <textarea style="width: 800px; height: 50px;" maxlength="1000" name="expcomp">
        ...
        <hr> 
     <b> Significant contributions to institute management through personal initiative in responsible positions.</b><br><br>
    <textarea style="width: 800px; height: 50px;" maxlength="1000" name="respos">
    </textarea>
     <hr>
