...
$sql =  "SELECT * FROM eq6page WHERE appn='$vapn'";
$result1 =  mysqli_query($link, $sql);
$row=$result1->fetch_array();
$sql =  "SELECT * FROM eq6 WHERE appn='$vapn'";
...
<?php
    ...
    if($row1['E61']!="")
    {
      ...
      <tr>
            ...
            <td><input type="text" class="textbox" id="numdays" name="E65" style="width:150px;" value="<?php echo $row1['E66']; ?>" readonly></td>
            <td><input type="text" size="10" name="E66"  style="width:100px;" value="<?php echo $row1['E65']; ?>" readonly> </td>
...
<b> 16.  Books / Chapters Published & E-learning materials Developed (last 4 years) </b> 
    <?php
            if($row1['BInternational']!="")
            {
                ?>
    <br><br>
    <textarea name="BInternational"  style="width: 800px; height: 50px;" rows="" cols="200" readonly > <?php echo $row1['BInternational']; ?></textarea> 
 <?php  
}
?>
               <hr>      
 <br>
    ...
    <?php
            ...
            {
                ?>
         <textarea name="patents" style="width: 800px; height: 50px;"rows="4" cols="100" readonly><?php echo $row['patents']; ?></textarea>
...
<hr>   <b>22. Industrial Experience/Interaction (Upload photocopies)  </b> <br><br>
                       <table style="text-align: center">
    <tr>
        <td>Organization</td>
...
<hr> </div>
        ...
        <b>28. Please indicate how in your opinion you can contribute to NITK's growth. (upload relevant document) <br>  <br>
...
<p width="80%" style="width:80%">   <b> 
     ...
     <textarea name="expcomp" style="width: 800px; height: 50px;" rows="" cols="200" readonly ><?php echo $row1['expcomp']; ?></textarea>
    
     <hr>
      <b> Strong liaison with industry; Offering courses through application of ICT. </b>             
     <br> <br>
     <textarea name="respos" style="width: 800px; height: 50px;"  rows="" cols="200"  readonly><?php echo $row1['respos']; ?></textarea>
