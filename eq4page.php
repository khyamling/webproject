...
<hr>    
    ...
    <b>18. Sponsored Projects (Project handled as Principal Investigator in Since last promotion) as per Gazette Note 1(4)</b>
    <br><br>
...
<p width="80%" style="width:80%">   <b>
 ...
 <hr>    
  <!--   <b> Two experiments or computational projects added to teaching laboratories.</b><br><br>
    <textarea name="lab" style="width: 800px; height: 50px;"  maxlength="1000" rows="" cols="500"  > </textarea>
    
     <hr> -->
      <b> Strong liaison with industry; Offering courses through application of ICT. </b>             
     <br> <br>
     <textarea name="industry" style="width: 800px; height: 50px;"  maxlength="1000" rows="" cols="500"  > </textarea>
