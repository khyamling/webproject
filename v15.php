 ...
 */
 ...
 $sql =  "SELECT * FROM newrules5 WHERE appn='$vapn'";
...
$sql  = "SELECT * FROM  profex5 WHERE email='$UID' and appn='$vapn'";
$exp3 =  mysqli_query($link, $sql);
$rowexp1=$exp3->fetch_array();
...
<tr><td colspan="9">
               <b>1.External sponsored R & D Projects completed or ongoing/patent granted</b>
</td>
    </tr>   
<tr>
...
<table style="FONT-SIZE: 8pt;"   border="1" cellspacing="2" cellpadding="2"> 
      <tr><td colspan="2">
          <b> 2. Consultancy Projects  </b>
                ...
                <tr>
                    <th colspan="2">No. of consultancy Projects(in Lakhs) - 2 credit point @ Rs. 5 lakhs of consultancy</th> 
                </tr>
                <tr>
 ...
 <tr>
                 ...
                 <?php $result2=2*floor($row4['consult']/5);
...
<tr> <td style="width: 350">  Number of significant outreach Institute activities  <br> (1 credit point per activity)</td>
     ...
     <?php $totalcount20= $row4['outreach'];?>
</tr>
<tr> <td style="width: 350"> Total Credit Points</td>
...
<table style="FONT-SIZE: 8pt;"  border="1" cellspacing="2">
   ...
   <tr> <td style="width: 660" colspan="2">Total Working Experience: </td> </tr>
   ...
   <tr> <td style="width: 660" colspan="2"> Experience at the level of Assistant <br> Professor(AGP:8000) or equivalent : <br> <?php echo $rowexp1['tier']; ?> </td> </tr>
    <tr> <td style="width: 330">Year</td>
       <td style="width: 330"><?php echo $rowexp['nexap']; ?></td> </tr>
   <tr> <td style="width: 330">Month</td>
       <td style="width: 330"><?php echo $rowexp['nexap1']; ?></td> </tr> 
</table>
</page>
...
<th>
      ...
      <?php
       ...
       ?>
        ...
        <th> Associate Professor or equivalent:</th> <td  style="width:80px"> <?php echo $row['assoprofexp']; ?></td>
        <th> Professor or equivalent:</th> <td  style="width:80px"> <?php echo $row['profexp']; ?></td></tr>
        </table>
...
<table style="FONT-SIZE: 8pt;">
    <tr> <td style="width:620">
            <b>16.  Books / Chapters Published & E-learning materials Developed (Since last promotion): </b> </td></tr>
    <tr> <td style="width:620">         
    <?php echo $row['BInternational']; ?>
       ...
       <table style="FONT-SIZE: 8pt;" border="1" cellspacing="1" cellpadding="2" >
         <tr> <td colspan="6">  <b>18. Sponsored Projects (Project handled as Principal Investigator, Since last promotion)</b> </td> </tr>
      ...
      <tr> <td colspan="4"> <b>19. Consultancy Project (Since last promotion)</b> </td> </tr>
...
<?php
           ...
           ?>
        <tr>
            <td style="width:160"><?php echo $row1['F11']; ?></td>
            <td style="width:300"><?php echo $row1['F12']; ?></td>
            <td style="width:105"><?php echo $row1['F13']; ?></td>
            <td style="width:105"><?php echo $row1['F14']; ?>"</td>
        ...
        <?php
           ...
           ?>   
         <tr>
              <td style="width:160"><?php echo $row1['F21']; ?></td>
            <td style="width:300"><?php echo $row1['F22']; ?></td>
            <td style="width:105"><?php echo $row1['F23']; ?></td>
            <td style="width:105"><?php echo $row1['F24']; ?>"</td>
        ...
        <?php
           ...
           ?>   
         <tr>
             <td style="width:160"><?php echo $row1['F31']; ?></td>
            <td style="width:300"><?php echo $row1['F32']; ?></td>
            <td style="width:105"><?php echo $row1['F33']; ?></td>
            <td style="width:105"><?php echo $row1['F34']; ?>"</td>
        ...
        <?php
           ...
           ?>   
         <tr>
              <td style="width:160"><?php echo $row1['F41']; ?></td>
            <td style="width:300"><?php echo $row1['F42']; ?></td>
            <td style="width:105"><?php echo $row1['F43']; ?></td>
            <td style="width:105"><?php echo $row1['F44']; ?>"</td>
        ...
        <?php
           ...
           ?>   
         <tr>
             <td style="width:160"><?php echo $row1['F51']; ?></td>
            <td style="width:300"><?php echo $row1['F52']; ?></td>
            <td style="width:105"><?php echo $row1['F53']; ?></td>
        ...
        <?php
           ...
           <br>
        <table style="FONT-SIZE: 8pt;" border="1" cellspacing="1" cellpadding="2">
        <tr> <td colspan="4"><b>20. Professional Training Received / Summer / Winter Schools Conducted(Since last promotion - Upload photocopies)</b> </td></tr>
 ...
 <?php
           ...
           <br>
         <table style="FONT-SIZE: 8pt;" border="1" cellspacing="1" cellpadding="2">
             <tr> <td colspan="3"> <b>21. Conferences/Seminars / Workshops Conducted (Since last promotion -Upload photocopies of the certificates)</b> </td> </tr>
        <tr>
...
<table style="FONT-SIZE: 8pt;" border="1" cellspacing="1" cellpadding="2">
            <tr>
                <td colspan="3">  <b>22. Continuing Education Programmes /Short Term Courses/Workshops/Seminars etc. organized (Since last promotion):</b></td>
            </tr>
        ...
        if($row1['fa11']!="")
            {
                    ?>
            <tr>
        <td style="width:300" ><?php echo $row1['fa11']; ?></td>
        <td style="width:130"><?php echo $row1['fa12']; ?> </td>
        <td style="width:300"><?php echo $row1['fa13']; ?></td>
       </tr>
          <?php
            }
            if($row1['fa21']!="")
            {
                    ?>
       <tr>
         <td style="width:300" ><?php echo $row1['fa21']; ?></td>
        <td style="width:130"><?php echo $row1['fa22']; ?> </td>
        <td style="width:300"><?php echo $row1['fa23']; ?></td>
    </tr>
       <?php
            }
            if($row1['fa31']!="")
            {
                    ?>
     <tr>
        <td style="width:300" ><?php echo $row1['fa31']; ?></td>
        <td style="width:130"><?php echo $row1['fa32']; ?> </td>
        <td style="width:300"><?php echo $row1['fa33']; ?></td>
    </tr>
       <?php
            }
            if($row1['fa41']!="")
            {
                    ?>
    <tr>
        <td style="width:300" ><?php echo $row1['fa41']; ?></td>
        <td style="width:130"><?php echo $row1['fa42']; ?> </td>
        <td style="width:300"><?php echo $row1['fa43']; ?></td>
    </tr>
       <?php
            }
            if($row1['fa51']!="")
            {
                    ?>
    <tr>
         <td style="width:300" ><?php echo $row1['fa51']; ?></td>
        <td style="width:130"><?php echo $row1['fa52']; ?> </td>
        <td style="width:300"><?php echo $row1['fa53']; ?></td>
    </tr> 
       <?php
            }
            if($row1['fa61']!="")
            {
                    ?>
    <tr>
         <td style="width:300" ><?php echo $row1['fa61']; ?></td>
        <td style="width:130"><?php echo $row1['fa62']; ?> </td>
        <td style="width:300"><?php echo $row1['fa63']; ?></td>
    </tr> 
       <?php
            }
            if($row1['fa71']!="")
            {
                    ?>
    <tr>
         <td style="width:300" ><?php echo $row1['fa71']; ?></td>
        <td style="width:130"><?php echo $row1['fa72']; ?> </td>
        <td style="width:300"><?php echo $row1['fa73']; ?></td>
    </tr> 
       <?php
            }
            if($row1['fa81']!="")
            {
                    ?>
    <tr>
        <td style="width:300" ><?php echo $row1['fa81']; ?></td>
        <td style="width:130"><?php echo $row1['fa82']; ?> </td>
        <td style="width:300"><?php echo $row1['fa83']; ?></td>
    </tr> 
       <?php
            }
            if($row1['fa91']!="")
            {
                    ?>
    <tr>
        <td style="width:300" ><?php echo $row1['fa91']; ?></td>
        <td style="width:130"><?php echo $row1['fa92']; ?> </td>
        <td style="width:300"><?php echo $row1['fa93']; ?></td>
    </tr> 
       <?php
            }
            if($row1['fa101']!="")
            {
                    ?>
    <tr>
        <td style="width:300" ><?php echo $row1['fa101']; ?></td>
        <td style="width:130"><?php echo $row1['fa102']; ?> </td>
        <td style="width:300"><?php echo $row1['fa103']; ?></td>
    </tr>
   <?php
            }   ?>
        </table>
        ...
        <table style="FONT-SIZE: 8pt;">
            <tr>
                <td> <b>23. Experience in Administrative Positions, Curriculum and Lab Development,  Student Welfare, Professional and Outreach Activities - Non remunerative (upload relevant document(s)) </b>  </td>
            </tr>
            <tr> <td style="width:730"><?php echo $row['edp']; ?></td> </tr>
        </table>
             <br>
            <table  style="FONT-SIZE: 8pt;">
                <tr> <td><b>24. Awards and Recognitions (Upload photocopies)</b> </td>
                </tr>
                <tr><td style="width:730"> <?php echo $row['ar']; ?> </td>
            </tr>
            <tr>
                <td><b>25. Any other relevant information you may like to furnish: </b></td>
            </tr>
            <tr>
         ...
         <table style="FONT-SIZE: 8pt;" > 
            <tr>
                <td colspan="4" >
                  <b>26. Names and addresses of two Professional References (Upload Testimonials of Them) </b>  
                </td>
            </tr>
            <tr>
                <td> Name   1. :</td>
...
<table style="FONT-SIZE: 8pt;" >
            ...
            <tr>
                ...
                <td> <b>27. Please indicate how in your opinion you can contribute to NITK's growth. (upload relevant document) </b></td> 
...
<table style="FONT-SIZE: 8pt;" >
            ...
            <tr>
                ...
                <td> <b>Strong liaison with industry; Offering courses through application of ICT. </b></td> 
              
            </tr>
            <tr>     <td style="width:620"><?php echo $row1['industry']; ?>   </td>          </tr>
       ...
       <table style="FONT-SIZE: 8pt;">
            <tr>   <td colspan="4">
     <b>28. I hereby declare that the entries in this form are true to the best of my knowledge and belief. I understand that my Candidature will be cancelled if any of the information is found to be false or incorrect. Further, if selected, I will abide by
