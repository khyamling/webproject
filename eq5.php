...
function valid(){
	...
	input6 = document.getElementById('tier').value;
   ...
   if(t1==t)
   {
    ...
    if(daysOfYearap > 1459)
     {
            
         if(dayOfYearphd >3649)    		
       {
 ...
 <li><a href="jaddd.php">Publication Details</a></li>
        ...
        <form action="eq5page.php" method="post" name="f1" onsubmit="return validateform()" >
           <hr>
 ...
 <b> 7. Academic - Doctoral Degree[Ph.D] Details:(Upload photocopies)  </b>
  ...
  <table style="table-layout: fixed;" cellpadding="1" cellspacing="" >
     ...
     <hr>
     <table>
         <tr> <p><b>Relevant Experience </b></p>
...
<td> 
  ...
  <option value="3">3-Tier Position Post</option>
  <option value="4">4-Tier Position Post</option>
</select> </td>
<td>
...
<hr>
<table>
15.c. Details of all other publications can be added through the 'Publication Details' Tab.
...
<hr>   
     ...
     <br> <br>
     <textarea name="industry"  style="width: 800px; height: 50px;" rows="" maxlength="1000" cols="200"  > </textarea> 
