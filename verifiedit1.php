 ...
 * 
 */
$sql1 =  "SELECT * FROM newrules1src WHERE appn='$vapn'";
...
<center>   <input type="submit" id="btn1" formaction="creditverify1.php" value="Edit" name="Submit">  <input type="submit" id="btn1" formaction="creditsubmit1.php" value="Submit" name="Submit">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
