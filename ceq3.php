...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="veq3.php" method="post" name="f1" >
      <hr>
      <table  rule="rows">
          <tr>
      ...
      <table>
          <tr>
              <th>  <p> Faculty Name :<input type="text"  name="name" value="<?php echo $row['name']; ?> " readonly/> </p></th>
            </tr>
</table>
 <hr>  
...
<center>   <input type="submit" id="btn1" formaction="veq3.php" value="Next" name="save">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
