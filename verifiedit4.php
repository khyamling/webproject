 ...
 $link = mysqli_connect("localhost", "root", "123html2pdf", "employment");
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4scr']);
    ...
    $status1="N";
     ...
     $sql  = "SELECT * FROM  newrules4src WHERE appn='$vapn' ";
     $result =  mysqli_query($link, $sql);
     $num_rows = mysqli_num_rows($result);
    //echo $num_rows;
if($num_rows > 0)
{
    $sql="UPDATE newrules4src  SET name='$name', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
{    
$sql = "insert into newrules4src values('$name', '$loneproj', '$teamproj', '$coproj', '$patgrant', '$consult', '$loneguide',
 ...
 * 
 */
$sql1 =  "SELECT * FROM newrules4src WHERE appn='$vapn'";
...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="veq4.php" method="post" name="f1" >
      <hr>
      <table  rule="rows">
          <tr>
