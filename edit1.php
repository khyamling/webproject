 ...
 */
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4']);
     ...
     $sql  = "SELECT * FROM  newrules1 WHERE appn='$nappn' ";
...
<div class="navbar navbar-fixed-top">
 ...
 <li><a href="submit.php">Submit/Print Application</a></li>
        ...
        <form action="eq1pageinsert.php" method="post" name="f1" >
...
<hr>
   ...
   <tr>
       <td >
        ...
        <td>
            <input type="text" size="40" maxlength="100"  readonly name="Page1" value="<?php echo $addv; ?>"  />
       </td>
       <td >
       <b>   Application No.</b>
       </td> 
        ...
        <td>
            <input type="text" size="40" maxlength="100" readonly  name="nappn" value="<?php echo $vapn?>"  />
       </td>
     </tr>
      </table>
                        <hr>
        ...
        <b>  Post Applied.</b>
         ...
         <td>
          <input type="text" style="width: 450px;"  readonly name="Page2" value="<?php echo $post; ?>"  />                       
       </td>
       <td align="left">
       <b>     AGP: </b> </td>
       <td><input type="text" style="width: 150px;" readonly  name="Page3" value="<?php echo $agp; ?>"  />                        </td>
       <td align="left">
        <b>  Department </b>
       </td>
         <td>
          <input type="text" style="width: 250px;"  readonly name="Page4" value="<?php echo $branch; ?>"  />                       
      </td>
          </tr>        </table>
                        <hr>
                        <table CELLPADDING=10 cellspacing="10" >
...
<td>  
 ...
 <tr>
     <td> <b> &nbsp;&nbsp; f) Percentage of Disability of PWD candidate  </td>  </b> <td><input type="text" name="Page18" value=" <?php echo  $row['Page18']; ?>" size="5" /> &nbsp;&nbsp;&nbsp;
     ...
     <td align="">  
      ...
      <tr><td>      City  </td> <td>  <input type="text" name="Page25" value="<?php echo $row['Page25']; ?>"  /> </td>  <td>&nbsp;&nbsp;&nbsp;</td> <td> City  </td> <td>  <input type="text" name="Page31" value="<?php echo $row['Page31']; ?>"  /> </td></tr>
           ...
           <tr> <td></td> <td></td><td></td>    <td>   Email</td> <td><input type="text" name="Page37" value="<?php echo $row['Page37']; ?>"  /></td></tr>
            ...
            <td>  <input style="width: 100px;"  id="start_dt" class='datepicker'  type="text" name="Page38" value="<?php echo $row['Page38']; ?>"  /> </td>
...
<hr>  
 ...
 <hr align="left">  
                                                 ...
                                                 <table>
                                                     <tr>  <td> <b> 5. Areas of specializations:(Mention area of specialization required for faculty position in various department as per guidelines  given in the advertisment notification(Select one or two from given list)) </b>
                                                         </td> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e19"   value="<?php echo $row['status1'] ?>"  style="width:100px;" ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e29"   value="<?php echo $row['status2'] ?>"  style="width:100px;"  ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e39"   value="<?php echo $row['status3'] ?>"  style="width:100px;"   ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e49"   value="<?php echo $row['status4'] ?>"  style="width:100px;"  ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e59"   value="<?php echo $row['status5'] ?>"  style="width:100px;"  ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e69"   value="<?php echo $row['status6'] ?>"  style="width:100px;" ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e79"   value="<?php echo $row['status7'] ?>"  style="width:100px;" ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e89"   value="<?php echo $row['status8'] ?>"  style="width:100px;" ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e99"   value="<?php echo $row['status9'] ?>"  style="width:100px;" ></td>
    </tr>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" name="e109"   value="<?php echo $row['status10'] ?>"  style="width:100px;" ></td>
    </tr>
    </table>
  <hr>
<b> 7. Academic - Doctoral Degree[Ph.D] Details:(Upload photocopies)  </b>
     ...
     $sql1 =  "SELECT * FROM postapplied WHERE appid='$vapn'";
$resultss =  mysqli_query($link, $sql1);
$rows=$resultss->fetch_array();
  //   $sql =  "SELECT * FROM postapplied WHERE appid='$vapn'";
//$result21 =  mysqli_query($link, $sql);
//$rows=$result21->fetch_array();
     if($rows['Industry']=="Y")
     {
    ...
    <hr align="left" >               
             ...
             <br>
               ...
               <tr >
                    <td>Examination </td>
                   <td>Year</td>
                   <td>Branch/Area of <br> Specialization</td>
                  <td>Score</td>
                    <td>Rank</td>
                    <td>Percentile</td>
                </tr> <tr>
...
<tr>For the current employed position, please enter Date of Leaving as the last date of the application submission </tr> </table>
    ...
    <tbody>
        <tr>
            <td><input type="text" size="30" name="E11" value="<?php echo $row['E11']; ?>" ></td>
            <td><input type="text" size="30" name="E12" value="<?php echo $row['E12']; ?>" > </td>
            <td> <input type="text" id="datepicker14"  name="E13" onchange="cal()"  style="width:100px;" value="<?php echo $row['E13']; ?>"  /> </td>
            <td><input type="text"  id="datepicker15" name="E14" onchange="cal()" style="width:100px;" value="<?php echo $row['E14']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays" name="E15" style="width:150px;" value="<?php echo $row['E15']; ?>" ></td>
            <td><input type="text" size="10" name="E16"  style="width:100px;" value="<?php echo $row['E16']; ?>" > </td>
            <td><input type="text" size="10" name="E17"  style="width:100px;" value="<?php echo $row['E17']; ?>" ></td>
      ...
      <tr>
            <td><input type="text" size="30" name="E21" value="<?php echo $row['E21']; ?>" ></td>
            <td><input type="text" size="30" name="E22" value="<?php echo $row['E22']; ?>" > </td>
            <td> <input type="text" id="datepicker16"  name="E23" onchange="cal1()"  style="width:100px;" value="<?php echo $row['E23']; ?>"  /> </td>
            <td><input type="text"  id="datepicker17" name="E24" onchange="cal1()" style="width:100px;" value="<?php echo $row['E24']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays1" name="E25" style="width:150px;" value="<?php echo $row['E25']; ?>" ></td>
            <td><input type="text" size="10" name="E26"  style="width:100px;" value="<?php echo $row['E26']; ?>" > </td>
            <td><input type="text" size="10" name="E27"  style="width:100px;" value="<?php echo $row['E27']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E31" value="<?php echo $row['E31']; ?>" ></td>
            <td><input type="text" size="30" name="E32" value="<?php echo $row['E32']; ?>" > </td>
            <td> <input type="text" id="datepicker18"  name="E33" onchange="cal2()"  style="width:100px;" value="<?php echo $row['E33']; ?>"  /> </td>
            <td><input type="text"  id="datepicker19" name="E34" onchange="cal2()" style="width:100px;" value="<?php echo $row['E34']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays2" name="E35" style="width:150px;" value="<?php echo $row['E35']; ?>" ></td>
            <td><input type="text" size="10" name="E36"  style="width:100px;" value="<?php echo $row['E36']; ?>" > </td>
            <td><input type="text" size="10" name="E37"  style="width:100px;" value="<?php echo $row['E37']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E41" value="<?php echo $row['E41']; ?>" ></td>
            <td><input type="text" size="30" name="E42" value="<?php echo $row['E42']; ?>" > </td>
            <td> <input type="text" id="datepicker20"  name="E43" onchange="cal3()"  style="width:100px;" value="<?php echo $row['E43']; ?>"  /> </td>
            <td><input type="text"  id="datepicker21" name="E44" onchange="cal3()" style="width:100px;" value="<?php echo $row['E44']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays3" name="E45" style="width:150px;" value="<?php echo $row['E45']; ?>" ></td>
            <td><input type="text" size="10" name="E46"  style="width:100px;" value="<?php echo $row['E46']; ?>" > </td>
            <td><input type="text" size="10" name="E47"  style="width:100px;" value="<?php echo $row['E47']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E51" value="<?php echo $row['E51']; ?>" ></td>
            <td><input type="text" size="30" name="E52" value="<?php echo $row['E52']; ?>" > </td>
            <td> <input type="text" id="datepicker22"  name="E53" onchange="cal4()"  style="width:100px;" value="<?php echo $row['E53']; ?>"  /> </td>
            <td><input type="text"  id="datepicker23" name="E54" onchange="cal4()" style="width:100px;" value="<?php echo $row['E54']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays4" name="E55" style="width:150px;" value="<?php echo $row['E55']; ?>" ></td>
            <td><input type="text" size="10" name="E56"  style="width:100px;" value="<?php echo $row['E56']; ?>" > </td>
            <td><input type="text" size="10" name="E57"  style="width:100px;" value="<?php echo $row['E57']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E61" value="<?php echo $row['E61']; ?>" ></td>
            <td><input type="text" size="30" name="E62" value="<?php echo $row['E62']; ?>" > </td>
            <td> <input type="text" id="datepicker24"  name="E63" onchange="cal5()"  style="width:100px;" value="<?php echo $row['E63']; ?>"  /> </td>
            <td><input type="text"  id="datepicker25" name="E64" onchange="cal5()" style="width:100px;" value="<?php echo $row['E64']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays5" name="E65" style="width:150px;" value="<?php echo $row['E65']; ?>" ></td>
            <td><input type="text" size="10" name="E66"  style="width:100px;" value="<?php echo $row['E66']; ?>" > </td>
            <td><input type="text" size="10" name="E67"  style="width:100px;" value="<?php echo $row['E67']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E71" value="<?php echo $row['E71']; ?>" ></td>
            <td><input type="text" size="30" name="E72" value="<?php echo $row['E72']; ?>" > </td>
            <td> <input type="text" id="datepicker26"  name="E73" onchange="cal6()"  style="width:100px;" value="<?php echo $row['E73']; ?>"  /> </td>
            <td><input type="text"  id="datepicker27" name="E74" onchange="cal6()" style="width:100px;" value="<?php echo $row['E74']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays6" name="E75" style="width:150px;" value="<?php echo $row['E75']; ?>" ></td>
            <td><input type="text" size="10" name="E76"  style="width:100px;" value="<?php echo $row['E76']; ?>" > </td>
            <td><input type="text" size="10" name="E77"  style="width:100px;" value="<?php echo $row['E77']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E81" value="<?php echo $row['E81']; ?>" ></td>
            <td><input type="text" size="30" name="E82" value="<?php echo $row['E82']; ?>" > </td>
            <td> <input type="text" id="datepicker28"  name="E83" onchange="cal7()"  style="width:100px;" value="<?php echo $row['E83']; ?>"  /> </td>
            <td><input type="text"  id="datepicker29" name="E84" onchange="cal7()" style="width:100px;" value="<?php echo $row['E84']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays7" name="E85" style="width:150px;" value="<?php echo $row['E85']; ?>" ></td>
            <td><input type="text" size="10" name="E86"  style="width:100px;" value="<?php echo $row['E86']; ?>" > </td>
            <td><input type="text" size="10" name="E87"  style="width:100px;" value="<?php echo $row['E87']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E91" value="<?php echo $row['E91']; ?>" ></td>
            <td><input type="text" size="30" name="E92" value="<?php echo $row['E92']; ?>" > </td>
            <td> <input type="text" id="datepicker30"  name="E93" onchange="cal8()"  style="width:100px;" value="<?php echo $row['E93']; ?>"  /> </td>
            <td><input type="text"  id="datepicker31" name="E94" onchange="cal8()" style="width:100px;" value="<?php echo $row['E94']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays8" name="E95" style="width:150px;" value="<?php echo $row['E95']; ?>" ></td>
            <td><input type="text" size="10" name="E96"  style="width:100px;" value="<?php echo $row['E96']; ?>" > </td>
            <td><input type="text" size="10" name="E97"  style="width:100px;" value="<?php echo $row['E97']; ?>" ></td>
            
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
      <tr>
            <td><input type="text" size="30" name="E101" value="<?php echo $row['E101']; ?>" ></td>
            <td><input type="text" size="30" name="E102" value="<?php echo $row['E102']; ?>" > </td>
            <td> <input type="text" id="datepicker32"  name="E103" onchange="cal9()"  style="width:100px;" value="<?php echo $row['E103']; ?>"  /> </td>
            <td><input type="text"  id="datepicker33" name="E104" onchange="cal9()" style="width:100px;" value="<?php echo $row['E104']; ?>" ></td>
            <td><input type="text" class="textbox" id="numdays9" name="E105" style="width:150px;" value="<?php echo $row['E105']; ?>" ></td>
            <td><input type="text" size="10" name="E106"  style="width:100px;" value="<?php echo $row['E106']; ?>" > </td>
            <td><input type="text" size="10" name="E107"  style="width:100px;" value="<?php echo $row['E107']; ?>" ></td>
   ...
   <b>13. Subjects Taught (Since last promotion)</b> 
   <br><br>
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
        ...
        <tr>
            ...
            <td><select name="E2_102" id="E2_102">
...
<tr><td> Completed (Guided Sole): </td>  <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <td>
          <input name="phdcomplete" type="text" maxlength="150" size="25" value="<?php echo $row['phdcomplete']; ?>"/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="phdongoing" type="text" maxlength="150" size="25" value="<?php echo $row['phdongoing']; ?>" />
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="cj1" type="text" maxlength="150" size="25" value="<?php echo $row['cj1']; ?>" />
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="oj1" type="text" maxlength="150" size="25"  value="<?php echo $row['oj1']; ?>"/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
    </tr>
       ...
       <td align="right">
        ...
        <td>
          <input name="pgcomplete" type="text" maxlength="150" size="25" value="<?php echo $row['pgcomplete']; ?>" />
       ...
       <td align="right">
        ...
        <td>
          <input name="pgongoing" type="text" maxlength="150" size="25" value="<?php echo $row['pgongoing']; ?>" />
        ...
        <td>
          <input name="cj2" type="text" maxlength="150" size="25"  value="<?php echo $row['cj2']; ?>"/>
        ...
        <td>
          <input name="oj2" type="text" maxlength="150" size="25"  value="<?php echo $row['oj2']; ?>"/>
...
<b>15. a. Publication details - No. of Papers </b> 
   ...
   <tr> 
    ...
    <tbody>
     ...
     <tr>
           <td><input type="text" size="20" name="E3_11" value="<?php echo $row1['E3_11']; ?>"  /> </td>
            <td><input type="text" size="30" name="E3_12" value="<?php echo $row1['E3_12']; ?>"  /> </td>
     <td>             
            <label for="E3_13"></label>
            <input type="text"  maxlength="150"  size="20"  id="E3_13" name="E3_13"  value="<?php echo $row1['E3_13']; ?>"></td>
           
    <!--  <td><input type="text" size="20" name="E3_13" value="<?php echo $row1['E3_13']; ?>"  /> </td> -->
            <td><input type="text" size="20" name="E3_14" value="<?php echo $row1['E3_14']; ?>"  /> </td>
            <td><input type="text" size="10" name="E3_15" value="<?php echo $row1['E3_15']; ?>"  /> </td>
            <td><input type="text" name="E3_16" value="<?php echo $row1['E3_16']; ?>"  /> </td>
            <td><input type="text"   name="E3_17" value="<?php echo $row1['E3_17']; ?>"  /></td>
       ...
       <tr>
           <td><input type="text" size="20" name="E3_21" value="<?php echo $row1['E3_21']; ?>"  /> </td>
            <td><input type="text" size="30" name="E3_22" value="<?php echo $row1['E3_22']; ?>"  /> </td>
	 <td>
            <label for="E3_23"></label>
            <input type="text"  maxlength="150"  size="20"   name="E3_23"  value="<?php echo $row1['E3_23']; ?>"></td>

   
      <!--       <td><input type="text" size="20" name="E3_23" value="<?php echo $row1['E3_23']; ?>"  /> </td>  -->
            <td><input type="text" size="20" name="E3_24" value="<?php echo $row1['E3_24']; ?>"  /> </td>
            <td><input type="text" size="10" name="E3_25" value="<?php echo $row1['E3_25']; ?>"  /> </td>
            <td><input type="text" name="E3_26" value="<?php echo $row1['E3_26']; ?>"  /> </td>
             <td><input type="text"   name="E3_27" value="<?php echo $row1['E3_27']; ?>"  /></td>
	    ...
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
         ...
         <tr>
           <td><input type="text" size="20" name="E3_31" value="<?php echo $row1['E3_31']; ?>"  /> </td>
            <td><input type="text" size="30" name="E3_32" value="<?php echo $row1['E3_32']; ?>"  /> </td>
<td>
            <label for="E3_33"></label>
            <input type="text"  maxlength="150"  size="20"   name="E3_33"  value="<?php echo $row1['E3_33']; ?>"></td>

            <td><input type="text" size="20" name="E3_34" value="<?php echo $row1['E3_34']; ?>"  /> </td>
            <td><input type="text" size="10" name="E3_35" value="<?php echo $row1['E3_35']; ?>"  /> </td>
            <td><input type="text"  name="E3_36" value="<?php echo $row1['E3_36']; ?>"  /> </td>
             <td><input type="text"   name="E3_37" value="<?php echo $row1['E3_37']; ?>"  /></td>
       ...
       <tr>
           <td><input type="text" size="20" name="E3_41" value="<?php echo $row1['E3_41']; ?>"  /> </td>
            <td><input type="text" size="30" name="E3_42" value="<?php echo $row1['E3_42']; ?>"  /> </td>
            <td><label for="E3_43"></label>
		<input type="text" size="20" name="E3_43"  value="<?php echo $row1['E3_43']; ?>"  /> </td>
            <td><input type="text" size="20" name="E3_44" value="<?php echo $row1['E3_44']; ?>"  /> </td>
            <td><input type="text" size="10" name="E3_45" value="<?php echo $row1['E3_45']; ?>"  /> </td>
            <td><input type="text" name="E3_46" value="<?php echo $row1['E3_46']; ?>"  /> </td>
            <td><input type="text"   name="E3_47" value="<?php echo $row1['E3_47']; ?>"  /></td>
...
<table>
    ...
    <br><br>
    <textarea name="BInternational"  style="width: 800px; height: 50px;" rows="" cols="200" maxlength="1000"   > <?php echo $row['BInternational']; ?></textarea> 
               <hr align="left" >      

               <b> 17. Patents(Applied or Awarded) </b> 
    <br>
    <textarea  style="width: 800px; height: 50px;"rows="4" cols="100" name="patents" type="text" maxlength="1000" size="25"  > <?php echo $row['patents']; ?></textarea>
                            
                            <hr align="left" >      
         
    <b>18. Sponsored Projects (Project handled as Principal Investigator)</b>
    <br><br>
        ...
        <tr>
          <td><input type="text" size="20" name="E4_11" value="<?php echo $row['E4_11']; ?>"  /></td>
            <td><input type="text" size="20" name="E4_12" value="<?php echo $row['E4_12']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_13" value="<?php echo $row['E4_13']; ?>"  /> </td>
            <td><input type="text" size="8" name="E4_14" value="<?php echo $row['E4_14']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_15" value="<?php echo $row['E4_15']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_16" value="<?php echo $row['E4_16']; ?>"  /></td>
             
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
        <tr>
          <td><input type="text" size="20" name="E4_21" value="<?php echo $row['E4_21']; ?>"  /></td>
            <td><input type="text" size="20" name="E4_22" value="<?php echo $row['E4_22']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_23" value="<?php echo $row['E4_23']; ?>"  /> </td>
            <td><input type="text" size="8" name="E4_24" value="<?php echo $row['E4_24']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_25" value="<?php echo $row['E4_25']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_26" value="<?php echo $row['E4_26']; ?>"  /></td>
             
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
        <tr>
          <td><input type="text" size="20" name="E4_31" value="<?php echo $row['E4_31']; ?>"  /></td>
            <td><input type="text" size="20" name="E4_32" value="<?php echo $row['E4_32']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_33" value="<?php echo $row['E4_33']; ?>"  /> </td>
            <td><input type="text" size="8" name="E4_34" value="<?php echo $row['E4_34']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_35" value="<?php echo $row['E4_35']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_36" value="<?php echo $row['E4_36']; ?>"  /></td>
             
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
        <tr>
          <td><input type="text" size="20" name="E4_41" value="<?php echo $row['E4_41']; ?>"  /></td>
            <td><input type="text" size="20" name="E4_42" value="<?php echo $row['E4_42']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_43" value="<?php echo $row['E4_43']; ?>"  /> </td>
            <td><input type="text" size="8" name="E4_44" value="<?php echo $row['E4_44']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_45" value="<?php echo $row['E4_45']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_46" value="<?php echo $row['E4_46']; ?>"  /></td>
             
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
        <tr>
          <td><input type="text" size="20" name="E4_51" value="<?php echo $row['E4_51']; ?>"  /></td>
            <td><input type="text" size="20" name="E4_52" value="<?php echo $row['E4_52']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_53" value="<?php echo $row['E4_53']; ?>"  /> </td>
            <td><input type="text" size="8" name="E4_54" value="<?php echo $row['E4_54']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_55" value="<?php echo $row['E4_55']; ?>"  /> </td>
            <td><input type="text" size="10" name="E4_56" value="<?php echo $row['E4_56']; ?>"  /></td>
	    ...
	    <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
                               ...
                               <b>19. Consultancy Projects</b> <br> <br>
        ...
        <tbody>
        <tr>
            <td><input type="text" size="20" name="F11" value="<?php echo $row['F11']; ?>"  /></td>
            <td><input type="text" size="20" name="F12" value="<?php echo $row['F12']; ?>"  /> </td>
            <td><input type="text" size="20" name="F13" value="<?php echo $row['F13']; ?>"  /> </td>
            <td><input type="text" size="20" name="F14" value="<?php echo $row['F14']; ?>"  /> </td>
      
        </tr>
         <tr>
            <td><input type="text" size="20" name="F21" value="<?php echo $row['F21']; ?>"  /></td>
            <td><input type="text" size="20" name="F22" value="<?php echo $row['F22']; ?>"  /> </td>
            <td><input type="text" size="20" name="F23" value="<?php echo $row['F23']; ?>"  /> </td>
            <td><input type="text" size="20" name="F24" value="<?php echo $row['F24']; ?>"  /> </td>
      
        </tr>
         <tr>
            <td><input type="text" size="20" name="F31" value="<?php echo $row['F31']; ?>"  /></td>
            <td><input type="text" size="20" name="F32" value="<?php echo $row['F32']; ?>"  /> </td>
            <td><input type="text" size="20" name="F33" value="<?php echo $row['F33']; ?>"  /> </td>
            <td><input type="text" size="20" name="F34" value="<?php echo $row['F34']; ?>"  /> </td>
      
        </tr>
         <tr>
            <td><input type="text" size="20" name="F41" value="<?php echo $row['F41']; ?>"  /></td>
            <td><input type="text" size="20" name="F42" value="<?php echo $row['F42']; ?>"  /> </td>
            <td><input type="text" size="20" name="F43" value="<?php echo $row['F43']; ?>"  /> </td>
            <td><input type="text" size="20" name="F44" value="<?php echo $row['F44']; ?>"  /> </td>
      
        </tr>
         <tr>
            <td><input type="text" size="20" name="F51" value="<?php echo $row['F51']; ?>"  /></td>
            <td><input type="text" size="20" name="F52" value="<?php echo $row['F52']; ?>"  /> </td>
            <td><input type="text" size="20" name="F53" value="<?php echo $row['F53']; ?>"  /> </td>
            <td><input type="text" size="20" name="F54" value="<?php echo $row['F54']; ?>"  /> </td>
                   ...
                   <hr align="left" >      
                   <b>20. Professional Training Received / Summer / Winter Schools attended(Since last promotion - Upload photocopies)</b><br><br>
...
<option value="2019">2019</option>
    ...
    <b> 21. Conferences/Seminars / Workshops attended (Since last promotion -Upload photocopies of the certificates)</b>
...
<option value="2019">2019</option>
    ...
    <tr>
        ...
        <hr align="left" > 
        <b>23. Continuing Education Programmes /Short Term Courses/Workshops/Seminars etc. organized (Since last promotion):</b> <br><br>
   ...
   <tr>
    ...
    <tr>
        <td><input type="text" name="fa11" value="<?php echo $row['fa11']; ?>"  /></td>
                    <td ><input type="text" name="fa12"  value="<?php echo $row['fa12']; ?>"  /> </td>
        <td><input type="text" name="fa13" value="<?php echo $row['fa13']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="fa21" value="<?php echo $row['fa21']; ?>"  /></td>
                    <td ><input type="text" name="fa22"  value="<?php echo $row['fa22']; ?>"  /> </td>
        <td><input type="text" name="fa23" value="<?php echo $row['fa23']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="fa31" value="<?php echo $row['fa31']; ?>"  /></td>
                    <td ><input type="text" name="fa32"  value="<?php echo $row['fa32']; ?>"  /> </td>
        <td><input type="text" name="fa33" value="<?php echo $row['fa33']; ?>"  /> </td>


    </tr>
    <tr>
       <td><input type="text" name="fa41" value="<?php echo $row['fa41']; ?>"  /></td>
                    <td ><input type="text" name="fa42"  value="<?php echo $row['fa42']; ?>"  /> </td>
        <td><input type="text" name="fa43" value="<?php echo $row['fa43']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="fa51" value="<?php echo $row['fa51']; ?>"  /></td>
                    <td ><input type="text" name="fa52"  value="<?php echo $row['fa52']; ?>"  /> </td>
        <td><input type="text" name="fa53" value="<?php echo $row['fa53']; ?>"  /> </td>

    </tr>
    <tr>
       <td><input type="text" name="fa61" value="<?php echo $row['fa61']; ?>"  /></td>
                    <td ><input type="text" name="fa62"  value="<?php echo $row['fa62']; ?>"  /> </td>
        <td><input type="text" name="fa63" value="<?php echo $row['fa63']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="fa71" value="<?php echo $row['fa71']; ?>"  /></td>
                    <td ><input type="text" name="fa72"  value="<?php echo $row['fa72']; ?>"  /> </td>
        <td><input type="text" name="fa73" value="<?php echo $row['fa73']; ?>"  /> </td>


    </tr>
    <tr>
        <td><input type="text" name="fa81" value="<?php echo $row['fa81']; ?>"  /></td>
                    <td ><input type="text" name="fa82"  value="<?php echo $row['fa82']; ?>"  /> </td>
        <td><input type="text" name="fa83" value="<?php echo $row['fa83']; ?>"  /> </td>

    </tr>
    <tr>
       <td><input type="text" name="fa91" value="<?php echo $row['fa91']; ?>"  /></td>
                    <td ><input type="text" name="fa92"  value="<?php echo $row['fa92']; ?>"  /> </td>
        <td><input type="text" name="fa93" value="<?php echo $row['fa93']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="fa101" value="<?php echo $row['fa101']; ?>"  /></td>
                    <td ><input type="text" name="fa102"  value="<?php echo $row['fa102']; ?>"  /> </td>
        <td><input type="text" name="fa103" value="<?php echo $row['fa103']; ?>"  /> </td>
 ...
 <textarea style="width: 800px; height: 50px;" maxlength="1000"  name="edp" ><?php echo $row['edp']; ?>
    </textarea>
         <hr align="left" > 
         <b>25. Awards and Recognitions (Upload photocopies)</b><br><br>
        
         <textarea style="width: 800px; height: 50px;" maxlength="1000"  name="ar" > <?php echo $row['ar']; ?>
    </textarea>
     <hr align="left" > 
     <b>26. Any other relevant information you may like to furnish:</b><br><br>
     <textarea style="width: 800px; height: 50px;"  maxlength="1000" name="ao" ><?php echo $row['ao']; ?>
    </textarea>
        <hr align="left" > 
...
<p  style="width:80%">   <b> 29. </b>I hereby declare that the entries in this form are true to the best of my knowledge and belief. I understand that my Candidature will be cancelled if any of the information is found to be false or incorrect. Further, if selected, I will abide by the rules and regulations of the institute and also the directions given to me from time to time. </p>
    ...
    <table  align="center" width="40%"> 
        <tr>
            <td><input type="submit" id="btn1" value="Save Application" name="previous"> <td></tr>
   </table>
