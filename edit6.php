 ...
 */
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4']);
    ...
    $nexap1 = mysqli_real_escape_string($link, $_POST['nexap1']);
     ...
     $sql  = "SELECT * FROM  newrules6 WHERE email='$UID' and appn='$nappn' ";
...
{    
$sql = "insert into newrules6 values('$name', '$loneproj', '$teamproj', '$coproj', '$patgrant', '$consult', '$loneguide',
...
<tr> For the current employed position, please enter Date of Leaving as the last date of the application submission </tr> </table>
    ...
    <tbody>
      ...
      <tr>
            ...
            <td><input type="text" class="textbox" id="numdays5" name="E65" style="width:150px;" value="<?php echo $row1['E66']; ?>" ></td>
            <td><input type="text" size="10" name="E66"  style="width:100px;" value="<?php echo $row1['E65']; ?>" > </td>
...
<table colspan="10">
             ...
             <tr><td>Duration after Masters' Degree (Not counting Ph.D enrolment period):</td>
...
<!--            <td><input type="text" size="20" name="E3_33" value="<?php echo $row1['E3_33']; ?>"  /> </td> -->
...
<hr>              
 <b> 16.  Books / Chapters Published & E-learning materials Developed (last 4 years) </b> 
    <br><br>
    <textarea name="BInternational"  style="width: 800px; height: 50px;" rows="" cols="200"  > <?php echo $row1['BInternational']; ?></textarea> 
  <hr>      
...
<table>
    <tr>     <td></td><td >2.&nbsp;&nbsp;&nbsp;<input type="text" style="width: 300px;" name="pr21" value="<?php echo $row['pr21']; ?>"  /></td>
     ...
     <br> <br>
     <textarea name="respos" style="width: 800px; height: 50px;"  rows="" cols="200"><?php echo $row1['respos']; ?></textarea>
