...
<style>
 ...
 <form action="rulesinserteq6.php" method="post" name="f1" >
      <table  rule="rows">
          <tr> <br><br><br>
...
<td>
<input type="text" maxlength="100" size="10"  id="nexap" name="nexap"  style="width:100px;" required></td>
<td> <input type="text" maxlength="100" size="10" id="nexap1" name="nexap1" required style="width:100px;"><td> </tr>
         
         </table> 
    <hr>
        <!--<br> <b>number of score is </b>: <br>-->
        <center>  <input type="submit" id="btn1" formaction="rulesinserteq6.php" value="calculate Credit" name="save"> </center>
