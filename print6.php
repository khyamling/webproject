...
$link = mysqli_connect("localhost", "root", "123html2pdf", "employment");
 ...
 //$res =  mysqli_query($link, $sql);
    ...
    $msg="<table border='1'><tr><th colspan='9'> <center><b>FACULTY RECRUITMENT UNDER 4-TIER FLEXIBLE FACULTY STRUCTURE</b> </center></td></tr>";
    $var="";
    echo $msg;
    $msg=" <tr><th colspan='9'><b> Dept. of ".$dept." </b> <br/><b> Post applied and AGP(level I) for ".$pop." </b></th ></tr>";
    echo $msg;
   $msg="<tr>  <b><th>Sl. No.</th > <th> Appn. No. </th ><th  style='width:350px'> Candidate Name </th ><th>Email </th ><th>Mobile No.</th > <th>Category</th ><th>PWD</th ><th>Eligible/Not eligible</th ><th>Reason for Not eligible</th ></b></tr>";
    echo $msg;
  ...
  // echo $msg;
    ...
    $sql="SELECT * FROM postapplied a JOIN $eq b ON a.appid=b.appn JOIN $eq1 c ON a.appid=c.appn  JOIN remarkeli d ON a.appid=d.appn";
  //echo $sql;
   // $res = mysql_query($sql);
     $res =  mysqli_query($link, $sql);
     $row=$res->fetch_array();
    ...
    $numcolumn = mysqli_num_fields($res); //will fetch number of field in table
     ...
     $msg="";
        ...
        if($pp==$b && $pp1==$p && $row['status']!=$n){
            ...
            $msg="<tr><td>".$cc."</td><td>".$row['appid']."</td><td style='width:350px'>".$row['Page5']."</td><td>".$row['Page37']."</td><td>".$row['Page34']."</td>
<td>".$row['Page12']."</td><td>".$row['Page19']."</td><td>".$row['eligible']."</td><td>".$row['remark']."</td></tr>";
        }
    ...
    while($row=mysqli_fetch_array($res))  //fetch all the row as array
    {
        ...
        $b= substr($vapn, 3, 3);
        if($pp==$b && $pp1==$p && $row['status']!=$n){
       $msg="<tr><td>".$cc."</td><td>".$row['appid']."</td><td style='width:350px'>".$row['Page5']."</td><td>".$row['Page37']."</td><td>".$row['Page34']."</td><td>".$row['Page12']."</td><td>".$row['Page19']."</td><td>".$row['eligible']."</td><td>".$row['remark']."</td></tr>";
        echo $msg;      
        $cc=$cc+1;
        }
...
echo "</table>"; 
echo "<table>";
echo  "Signature Members of the Department Screening Committee";
echo "</table>";
echo "<table>";
echo  "1.";
echo "</table>";
...
echo "</table>";
    ...
    $msg=" <tr><th colspan='9'><b> Dept. of ".$dept." </b> <br/><b>  Post applied and AGP(level II) for ".$pop." </b></th ></tr>";
    echo $msg;
     $msg="<tr>  <b><th>Sl. No.</th > <th> Appn. No. </th ><th  style='width:350px'> Candidate Name </th ><th>Email </th ><th>Mobile No.</th > <th>Category</th ><th>PWD</th ><th>Eligible/Not eligible</th ><th>Reason for Not eligible</th ></b></tr>";
    echo $msg;
...
echo "</table>";
    ...
    $msg=" <tr><th colspan='9'><b> Dept. of ".$dept." </b> <br/><b>  Post applied and AGP(level III) for ".$pop." </b></th ></tr>";
    echo $msg;
   $msg="<tr>  <b><th>Sl. No.</th > <th> Appn. No. </th ><th  style='width:350px'> Candidate Name </th ><th>Email </th ><th>Mobile No.</th > <th>Category</th ><th>PWD</th ><th>Eligible/Not eligible</th ><th>Reason for Not eligible</th ></b></tr>";
    echo $msg; 
