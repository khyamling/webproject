 ...
 */
  ...
  //   $gian4 = mysqli_real_escape_string($link, $_POST['gian4']);
    ...
    $nexap1 ="";
     ...
     $sql  = "SELECT * FROM  newrules3 WHERE appn='$nappn' ";
     $result =  mysqli_query($link, $sql);
$num_rows = mysqli_num_rows($result);
if($num_rows > 0)
{
    $sql="UPDATE newrules3  SET name='$name', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
{    
$sql = "insert into newrules3 values('$name', '$loneproj', '$teamproj', '$coproj', '$patgrant', '$consult', '$loneguide',
...
//$sql  = "SELECT * FROM  profex WHERE email='$UID' and appn='$nappn' ";
$result =  mysqli_query($link, $sql);
$num_rows = mysqli_num_rows($result);
if($num_rows > 0)
{
...
$sql  = "SELECT * FROM  profex WHERE email='$UID' and appn='$vapn'";
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                                                          ...
                                                          <li><a href="up.php">Upload Photo/Documents </a></li>
                                                               <li><a href="view1.php">View/Edit Application</a></li>                                                                                                                                                                                         <li><a href="jaddd.php">Publication Details</a></li>
             ...
             <br>
               ...
               <tr >
                  ...
                  <td>Score</td>
                    ...
                    <td><textarea rows="1" cols="50"  input type="text" name="nt11" > <?php echo $row['examination1']; ?> </textarea> </td> 
...
<option value="2019">2019</option>
    ...
    <option value="1939">1939</option>
                    ...
                    <td align='center'><input type="text" name="nt16" class="form-control" size="10"  style="width:100px;"  value="<?php echo $row['percentile1']; ?>" > </td> 
                     ...
                     <td><textarea rows="1" cols="50"  input type="text" name="nt21" > <?php echo $row['examination2']; ?> </textarea> </td> 
 ...
 <table  width="60%" style=" text-align:center;" >
    ...
    <tbody>
      ...
      <tr>
            ...
            <td><input type="text"  id="datepicker29" name="E84" onchange="cal7()" style="width:100px;" value="<?php echo $row1['E84']; ?>" ></td>
...
<hr>
<p> <b> 10. a. Experience(Mandatory Field) </b> </p>
<table colspan="10">
             <tr><td colspan="3"></td></tr>
             <tr> <td> &nbsp;</td><td> &nbsp;&nbsp;&nbsp; Year&nbsp;&nbsp;</td> <td>&nbsp;&nbsp;&nbsp; Months</td> </tr>
             <tr><td>After Masters (PG) :</td>
	     <td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg" value="<?php echo $rowexp['nexpg']; ?>" style="width:100px;" required></td>
             <td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1" value="<?php echo $rowexp['nexpg1']; ?>" style="width:100px;" required><td> </tr>
   <tr>      <td>After Ph.D :<td> <input type="text" maxlength="100" size="10"  id="nexphd" name="nexphd"  value="<?php echo $rowexp['nexphd']; ?>"  style="width:100px;" required></td>
              <td> <input type="text" maxlength="100" size="10" id="nexphd1" name="nexphd1" value="<?php echo $rowexp['nexphd1']; ?>" style="width:100px;" required><td> </tr>
...
<tr><td> Completed (Guided Sole): </td>  <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <td>
          <input name="phdcomplete" type="text" maxlength="150" size="25" value="<?php echo $row1['phdcomplete']; ?>"/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="phdongoing" type="text" maxlength="150" size="25" value="<?php echo $row1['phdongoing']; ?>" />
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="cj1" type="text" maxlength="150" size="25" value="<?php echo $row1['cj1']; ?>" />
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="oj1" type="text" maxlength="150" size="25"  value="<?php echo $row1['oj1']; ?>"/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
    </tr>
       ...
       <td align="right">
        ...
        <td>
          <input name="pgcomplete" type="text" maxlength="150" size="25" value="<?php echo $row1['pgcomplete']; ?>" />
       ...
       <td align="right">
        ...
        <td>
          <input name="pgongoing" type="text" maxlength="150" size="25" value="<?php echo $row1['pgongoing']; ?>" />
        ...
        <td>
          <input name="cj2" type="text" maxlength="150" size="25"  value="<?php echo $row1['cj2']; ?>"/>
        ...
        <td>
          <input name="oj2" type="text" maxlength="150" size="25"  value="<?php echo $row1['oj2']; ?>"/>
...
<b>15. a. Publication details - No. of Papers </b> 
 ...
 <tr>
     ...
     <td>
            ...
            <input type="text"  maxlength="150"  size="20"   name="E3_13"  value="<?php echo $row1['E3_13']; ?>"></td>
        ...
        <tr>
         ...
         <tr>
            ...
            <td><input type="text" size="20" name="F54" value="<?php echo $row['F54']; ?>"  /> </td>
                   ...
                   <hr align="left" >      
                   <b>20. Professional Training Received / Summer / Winter Schools Conducted(Since last promotion - Upload photocopies)</b><br><br>
...
<option value="2019">2019</option>
    ...
    <tr>
    <tr>
        <td><input type="text" name="ie11" value="<?php echo $row1['ie11']; ?>"  /></td>
                    <td ><input type="text" name="ie12"  value="<?php echo $row1['ie12']; ?>"  /> </td>
        <td><input type="text" name="ie13" value="<?php echo $row1['ie13']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie21" value="<?php echo $row1['ie21']; ?>"  /></td>
                    <td ><input type="text" name="ie22"  value="<?php echo $row1['ie22']; ?>"  /> </td>
        <td><input type="text" name="ie23" value="<?php echo $row1['ie23']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie31" value="<?php echo $row1['ie31']; ?>"  /></td>
                    <td ><input type="text" name="ie32"  value="<?php echo $row1['ie32']; ?>"  /> </td>
        <td><input type="text" name="ie33" value="<?php echo $row1['ie33']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie41" value="<?php echo $row1['ie41']; ?>"  /></td>
                    <td ><input type="text" name="ie42"  value="<?php echo $row1['ie42']; ?>"  /> </td>
        <td><input type="text" name="ie43" value="<?php echo $row1['ie43']; ?>"  /> </td>


    </tr>
    <tr>
        <td><input type="text" name="ie51" value="<?php echo $row1['ie51']; ?>"  /></td>
                    <td ><input type="text" name="ie52"  value="<?php echo $row1['ie52']; ?>"  /> </td>
        <td><input type="text" name="ie53" value="<?php echo $row1['ie53']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie61" value="<?php echo $row1['ie61']; ?>"  /></td>
                    <td ><input type="text" name="ie62"  value="<?php echo $row1['ie62']; ?>"  /> </td>
        <td><input type="text" name="ie63" value="<?php echo $row1['ie63']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie71" value="<?php echo $row1['ie71']; ?>"  /></td>
                    <td ><input type="text" name="ie72"  value="<?php echo $row1['ie72']; ?>"  /> </td>
        <td><input type="text" name="ie73" value="<?php echo $row1['ie73']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie81" value="<?php echo $row1['ie81']; ?>"  /></td>
                    <td ><input type="text" name="ie82"  value="<?php echo $row1['ie82']; ?>"  /> </td>
        <td><input type="text" name="ie83" value="<?php echo $row1['ie83']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie91" value="<?php echo $row1['ie91']; ?>"  /></td>
                    <td ><input type="text" name="ie92"  value="<?php echo $row1['ie92']; ?>"  /> </td>
        <td><input type="text" name="ie93" value="<?php echo $row1['ie93']; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie101" value="<?php echo $row1['ie101']; ?>"  /></td>
                    <td ><input type="text" name="ie102"  value="<?php echo $row1['ie102']; ?>"  /> </td>
        <td><input type="text" name="ie103" value="<?php echo $row1['ie103']; ?>"  /> </td>


    </tr>
    </table>
        <hr align="left" > 
        <b>23. Continuing Education Programmes /Short Term Courses/Workshops/Seminars etc. organized (Since last promotion)(Attach relevant documents):</b> <br><br>
 ...
 <textarea style="width: 800px; height: 50px;" name="edp" ><?php echo $row['edp']; ?>
     ...
     <textarea style="width: 800px; height: 50px;" name="ao" ><?php echo $row['ao']; ?>
        ...
        <hr align="left" > 
        <b>27. Names and addresses of two Professional References (Upload Testimonials of Them)(Optional for Internal candidates): </b><br><br>
    ...
    <tr>     <td></td><td >2.&nbsp;&nbsp;&nbsp;<input type="text" style="width: 300px;" name="pr21" value="<?php echo $row['pr21']; ?>"  /></td>
     ...
     <b>28. Please indicate how in your opinion you can contribute to NITK's growth. (upload relevant document)
      ...
      <hr align="left" > 
        ...
        <textarea name="expcomp" style="width: 800px; height: 50px;"  rows="" cols="200"   ><?php echo $row1['expcomp']; ?></textarea>
    <hr align="left" >   

      <b> M.Tech., M..Sc. or B.Tech project supervision on live industrial problems. </b> 
    <br><br><br>
    <textarea name="live" style="width: 800px; height: 50px;"  rows="" cols="200"  ><?php echo $row1['live']; ?></textarea>
<hr align="left" > 
