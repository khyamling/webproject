...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="edit1.php" method="post" name="f1" >
      <hr>
      
        <table>
          <tr>
              <th>  <p> <font size="5"  face="Comic sans MS"  color="black" > Credit Earned:  <input type="text" name="credit1" value="<?php echo $row1['credit1']; ?>" readonly /> </font> </p> </th>
          </tr>
           </table>
      <hr>
      <table  rule="rows">
 ...
 <hr>
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p> <b>    3. One PhD Guided(including thesis submitted cases) </b> </p> </tr>
<tr> <td> 3a. No. of  PhD Completed/Thesis submitted - Lone supervisor </td> 
    <td>    <input name="loneguide" type="number" size="50" maxlength="150"  value="<?php echo $row['loneguide'] ?>" > </td> </tr>
<tr> <td> 3b. No. of  PhD Completed/Thesis submitted - Head supervisor </td>
    <td>  <input name="headguide" type="number" maxlength="150" size="25" value="<?php echo $row['headguide'] ?>" > </td> </tr>
<tr> <td> 3c. No. of PhD Completed/Thesis submitted - Co-supervisor </td> 
    <td>  <input name="coguide" type="number" maxlength="150" size="25" value="<?php echo $row['coguide'] ?>" > </td>   
 </tr>
</table>
 <hr>    
       
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p> <b> 4. One Journal papers in SCI/Scopus(Paid Journal not allowed) </b> </p> </tr>
<tr><td>    4a. No of  Journal - SCI/SCOPUS Indexed - First author/Main supervisor </td> 
    <td>   <input name="jmain" type="number" size="50" maxlength="150"  value="<?php echo $row['jmain'] ?>"  > </td> </tr>
<tr> <td>  4b. No of Journal - SCI/SCOPUS Indexed - Other author </td>
    <td>  <input name="jother" type="number" maxlength="150" size="25" value="<?php echo $row['jother'] ?>"  > </td>
 </tr>
</td>
</table>
 <hr>
...
<tr> <td>    5a. No. of Conference paper - First author/Main supervisor </td>
    <td> <input name="cmain" type="number" maxlength="150" size="25" value="<?php echo $row['cmain'] ?>"   </td></tr>
<tr> <td>    5b. No. of  Conference paper - Other author </td>
    <td>   <input name="cother" type="number" maxlength="150" size="25" value="<?php echo $row['cother'] ?>"  </td>
 </tr>
</td>
</table>       
...
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p> <b>     6. Administrative Responsibilities (HoD, Dean, Chief Warden,Prof - InCharge (T&P),
            Advisor(Estate), TEQUIP Co-ord) - No. of Semesters as (since last promotion):</b> </p> </tr>
<tr> <td> Number of semesters the HoD position was held </td>
    <td>  <input name="sixadmin1" type="number" maxlength="150" size="25" value="<?php echo $row ['sixadmin'] ?>"  > </td> </tr>
...
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p> <b>    9. Additional Responsibilities (Lab incharge, Dept level committee - min 1 year)- No. of Semesters as (since last promotion):</b> </p> </tr>
...
<tr> <td> No. of  GIAN Course Program Coordinator-1 week </td>
    <td> <input name="gian2" type="number" maxlength="150" size="25" value="<?php echo $row['gian3'] ?>"  > </td>
    </tr>
</table>
...
<table CELLPADDING=10 cellspacing="10">
    <tr>
    <p>  <b> 12. National/International Conference organized as Chairman/Secretary </b> </p> </tr>
...
<table CELLPADDING=10 cellspacing="10">
    <tr>
    <p> <b>  20.Significant outreach institute activies(Since last promotion) </b> </p> </tr>
...
<center>   <input type="submit" id="btn1" formaction="edit1.php" value="Submit" name="SubmitButton">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
