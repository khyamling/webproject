...
if(!$user_home->is_logged_in())
{
 ...
 //database for 6.academic career record starting with SSLC
  ...
  $sql  = "SELECT * FROM  eq1page WHERE appn='$nappn' ";
...
phdcomplete='$phdcomplete', pgcomplete='$pgcomplete', phdongoing='$phdongoing', pgongoing='$pgongoing', cj1='$cj1', cj2='$cj2', oj1='$oj1', oj2='$oj2',   
...
if(mysqli_query($link,$sql)){
      $xx= "Application Saved successfully. To view application check in view application menu and Application No:" .$nappn;
                ...
                $xx=  " insert qERROR: Could not able to Save. Try again in View Application. Application No:" .$nappn  .mysqli_error($link);
...
$sql  = "SELECT * FROM  eq1 WHERE appn='$nappn' ";
	//tmt->execute(array(":emailI=>$email));
