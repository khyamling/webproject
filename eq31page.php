...
//database from advertisement no to areas of specialization
 ...
 $sql  = "SELECT * FROM  eq3page WHERE email='$UID' and appn='$nappn' ";
...
examination5='$examination5', testyear5='$Testyear5', branch5='$Branch5', score5='$score5' , rank5='$rank5', percentile5='$percentile5' WHERE appn='$nappn' ";
...
$sql  = "SELECT * FROM  eq3 WHERE email='$UID' and appn='$nappn' ";
	//tmt->execute(array(":emailI=>$email));
...
if(mysqli_query($link, $sql)){
     ...
     //  echo "Aplication saved successfully";
...
$(function() {
 ...
 <div class="navbar navbar-fixed-top ">
  ...
  <li><a href="submit.php">Submit/Print Application</a></li>
        ...
        <form action="eq3pageinsert.php" method="post" name="f1" >
          <hr>
       <table>
          <tr>
                ...
                <tr >
                  ...
                  <td>Institute/Organization</td>
                    ...
                    <td> <textarea name="pd11"  maxlength="150"rows="1" cols="30" ><?php echo $_POST['pd11']; ?></textarea>
                        ...
                        <td ><input type="text" maxlength="150" name="pd14" class="form-control" size="40" value="<?php echo $_POST["pd14"]; ?>"  />  </td> 
                        <td><input type="text" maxlength="150" name="pd15" class="form-control" size="30" value="<?php echo $_POST["pd15"]; ?>"  /> </td> 
                      ...
                      <tr>
                          ...
                          <td><input type="text"  maxlength="20" id="datepicker6"  name="pd22"  style="width:100px;" value="<?php echo$_POST["pd22"]; ?>"  />  </td> 
                          <td><input type="text" maxlength="20"  id="datepicker7" name="pd23"  style="width:100px;" value="<?php echo $_POST["pd23"]; ?>"  /> </td> 
                          <td ><input type="text" maxlength="150" name="pd24" class="form-control" size="40" value="<?php echo $_POST["pd24"]; ?>"  />  </td> 
                          <td><input type="text" maxlength="150" name="pd25" class="form-control" size="30" value="<?php echo$_POST["pd25"]; ?>"  />  </td> 
                          <td align='center'><input type="text" maxlength="150" name="pd26" class="form-control" size="30" value="<?php echo $_POST["pd26"]; ?>"  />  </td> 
                    ...
                    <td><input type="text"  maxlength="20"  id="datepicker8" name="pd32"  style="width:100px;" value="<?php echo $_POST["pd32"]; ?>"  />  </td> 
                    <td><input type="text" maxlength="20"  id="datepicker9"  name="pd33"  style="width:100px;" value="<?php echo $_POST["pd33"]; ?>"  />   </td> 
                    <td ><input type="text" maxlength="150" name="pd34" class="form-control" size="40" value="<?php echo $_POST["pd34"]; ?>"  />  </td> 
                    <td><input type="text" maxlength="150" name="pd35" class="form-control" size="30" value="<?php echo $_POST["pd35"]; ?>"  />  </td> 
                    <td align='center'><input type="text" maxlength="150" name="pd36" class="form-control" size="30" value="<?php echo $_POST["pd36"]; ?>"  />  </td> 
                      </tr>
                       <tr>
                    ...
                    <td><input type="text" maxlength="20" id="datepicker10"    name="pd42"  style="width:100px;" value="<?php echo $_POST["pd42"]; ?>"  />  </td> 
                    <td><input type="text" maxlength="20" id="datepicker11"  name="pd43"   style="width:100px;" value="<?php echo $_POST["pd43"]; ?>"  />  </td> 
                    <td ><input type="text" maxlength="150" name="pd44" class="form-control" size="40" value="<?php echo $_POST["pd44"]; ?>"  />  </td> 
                    <td><input type="text" maxlength="150" name="pd45" class="form-control" size="30" value="<?php echo $_POST["pd45"]; ?>"  />  </td> 
                    <td align='center'><input type="text" maxlength="150" name="pd46" class="form-control" size="30" value="<?php echo $_POST["pd46"]; ?>"  />  </td> 
                      </tr>
                       <tr>
                           <td> <textarea name="pd51" maxlength="150" rows="1" cols="30" ><?php echo $_POST['pd51']; ?></textarea>
                        <!-- <input tyep="text" rows="1" cols="30"  input type="text" name="pd51"  id="message" placeholder="Career" value=""  />  -->
                    </td> 
                    <td><input type="text" maxlength="20" id="datepicker12" name="pd52"  style="width:100px;" value="<?php echo $_POST["pd52"]; ?>"  />   </td> 
                    <td><input type="text" maxlength="20" id="datepicker13"  name="pd53"   style="width:100px;" value="<?php echo $_POST["pd53"]; ?>"  />  </td> 
                    <td ><input type="text" maxlength="150" name="pd54" class="form-control" size="40" value="<?php echo $_POST["pd54"]; ?>"  />  </td> 
                    <td><input type="text" maxlength="150" name="pd55" class="form-control" size="30" value="<?php echo $_POST["pd55"]; ?>"  />  </td> 
                    <td align='center'><input type="text" maxlength="150" name="pd56" class="form-control" size="30" value="<?php echo $_POST["pd56"]; ?>"  />  </td> 
                      </tr>
            </table>    
  <hr>                      
...
<option value="2019">2019</option>
 ...
 <option value="2017">2017</option>
    ...
    <option value="1939">1939</option>
        ...
        <input id="btn1" type="submit" formaction="eq31page.php" value="Save Progress" name="previous">               </p>    
 <hr>
...
<table  width="60%" style=" text-align:center;" >
    ...
    <tbody>
   <tr>
            <td><input type="text" size="30" name="E11" value="<?php echo $E11; ?>"  maxlength="100" /></td>
            <td><input type="text" size="30" name="E12" value="<?php echo $E12; ?>"  maxlength="100" /></td>
            <td> <input type="text" id="datepicker14"  name="E13" onchange="cal()"  style="width:100px;" value="<?php echo $E13; ?>"  maxlength="100" /> </td>
            <td><input type="text"  id="datepicker15" name="E14" onchange="cal()" style="width:100px;" value="<?php echo $E14; ?>"   maxlength="100"/></td>
            <td><input type="text" class="textbox" id="numdays" name="E15" style="width:150px;" value="<?php echo $E15; ?>"   maxlength="100" /></td>
            <td><input type="text" size="10" name="E16"  style="width:100px;" value="<?php echo $E16 ?>"  maxlength="100" /></td>
            <td><input type="text" size="10" name="E17"  style="width:100px;" value="<?php echo $E17; ?>"  maxlength="100" /></td>
        ...
        <tr>
            <td><input type="text" size="30" name="E21" value="<?php echo $E21; ?>"  maxlength="100" /></td>
            <td><input type="text" size="30" name="E22" value="<?php echo $E22; ?>"  maxlength="100" /></td>
          <td><input type="text"  id="datepicker16" name="E23" onchange="cal1()"  style="width:100px;" value="<?php echo $E23; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker17"  name="E24" onchange="cal1()" style="width:100px;" value="<?php echo $E24; ?>"  maxlength="100" /></td>
            <td><input type="text" class="textbox" id="numdays1" name="E25" style="width:150px;" value="<?php echo $E25; ?>"  maxlength="100" /></td>
            <td><input type="text" size="10" name="E26"  style="width:100px;" value="<?php echo $E26; ?>"  maxlength="100"  /></td>
            <td><input type="text" size="10" name="E27"  style="width:100px;" value="<?php echo $E27; ?>"  maxlength="100" /></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
       ...
       <tr>
              <tr>
            <td><input type="text" size="30" name="E31" value="<?php echo $E31; ?>"  maxlength="100" /></td>
            <td><input type="text" size="30" name="E32" value="<?php echo $E32; ?>"  maxlength="100" /></td>
            <td> <input type="text" id="datepicker18"  name="E33" onchange="cal2()"  style="width:100px;" value="<?php echo $E33; ?>"  maxlength="100" /> </td>
            <td><input type="text"  id="datepicker19" name="E34" onchange="cal2()" style="width:100px;" value="<?php echo $E34; ?>"  maxlength="100" /> </td>
            <td><input type="text" class="textbox" id="numdays2" name="E35" style="width:150px;" value="<?php echo $E35; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E36"  style="width:100px;" value="<?php echo $E36; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E37"  style="width:100px;" value="<?php echo $E37; ?>"  maxlength="100" /> </td>
        ...
        <tr>
            <td><input type="text" size="30" name="E41" value="<?php echo $E41; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="30" name="E42" value="<?php echo $E42; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker20" name="E43" onchange="cal3()"  style="width:100px;"value="<?php echo $E43 ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker21" name="E44" onchange="cal3()" style="width:100px;" value="<?php echo $E44; ?>"  maxlength="100" /></td>
            <td><input type="text" class="textbox" id="numdays3" name="E45" style="width:150px;" value="<?php echo $E45; ?>"   maxlength="100" /> </td>
            <td><input type="text" size="10" name="E46"  style="width:100px;" value="<?php echo $E46; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E47"  style="width:100px;" value="<?php echo $E47; ?>"  maxlength="100" /> </td>
        ...
        <tr>
            <td><input type="text" size="30" name="E51" value="<?php echo $E51; ?>"  maxlength="100"  /> </td>
            <td><input type="text" size="30" name="E52" value="<?php echo $E52; ?>"  maxlength="100"  /> </td>
            <td><input type="text" id="datepicker22"  name="E53" onchange="cal4()"  style="width:100px;" value="<?php echo $E53; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker23"  name="E54" onchange="cal4()"  style="width:100px;" value="<?php echo $E54; ?>"   maxlength="100" /> </td>
            <td><input type="text" class="textbox" id="numdays4" name="E55"  style="width:150px;" value="<?php echo $E55; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E56"  style="width:100px;" value="<?php echo $E56; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E57"  style="width:100px;" value="<?php echo $E57; ?>"  maxlength="100" /> </td>
  
        </tr>

        <tr>
            <td><input type="text" size="30" name="E61" value="<?php echo $E61; ?>"  maxlength="100"  /> </td>
            <td><input type="text" size="30" name="E62" value="<?php echo $E62; ?>"  maxlength="100"  /> </td>
            <td><input type="text" id="datepicker24" name="E63" onchange="cal5()"  style="width:100px;" value="<?php echo $E63; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker25" name="E64" onchange="cal5()"  style="width:100px;" value="<?php echo $E64; ?>"  maxlength="100" /> </td>
            <td><input type="text" class="textbox" id="numdays5" name="E65"  style="width:150px;" value="<?php echo $E65; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E66"  style="width:100px;" value="<?php echo $E66; ?>"   maxlength="100" /> </td>
            <td><input type="text" size="10" name="E67"  style="width:100px;" value="<?php echo $E67; ?>"  maxlength="100" /> </td>
        ...
        <tr>
            <td><input type="text" size="30" name="E71" value="<?php echo $E71; ?>"  maxlength="100"  /> </td>
            <td><input type="text" size="30" name="E72" value="<?php echo $E72; ?>"  maxlength="100" /> </td>
          <td><input type="text"   id="datepicker26" name="E73" onchange="cal6()"  style="width:100px;"  value="<?php echo $E73; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker27"  name="E74" onchange="cal6()"  style="width:100px;" value="<?php echo $E74; ?>"  maxlength="100"  /> </td>
            <td><input type="text" class="textbox" id="numdays6" name="E75"  style="width:150px;" value="<?php echo $E75; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E76"  style="width:100px;" value="<?php echo $E76; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E77"  style="width:100px;" value="<?php echo $E77; ?>"  maxlength="100" /> </td>
         ...
         <tr>
            <td><input type="text" size="30" name="E81" value="<?php echo $E81; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="30" name="E82" value="<?php echo $E82; ?>"  maxlength="100" /> </td>
           <td><input type="text"  id="datepicker28" name="E83" onchange="cal7()"  style="width:100px;" value="<?php echo $E83; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker29" name="E84" onchange="cal7()" style="width:100px;" value="<?php echo $E84; ?>"  maxlength="100" /> </td>
            <td><input type="text" class="textbox" id="numdays7" name="E85" style="width:150px;" value="<?php echo $E85; ?>"   maxlength="100" /> </td>
            <td><input type="text" size="10" name="E86"  style="width:100px;" value="<?php echo $E86; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E87"  style="width:100px;" value="<?php echo $E87; ?>"  maxlength="100" /> </td>
            
            <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
         <tr>
            <td><input type="text" size="30" name="E91" value="<?php echo $E91; ?>"   maxlength="100"/> </td>
            <td><input type="text" size="30" name="E92" value="<?php echo $E92; ?>"   maxlength="100" /> </td>
            <td><input type="text" id="datepicker30" name="E93" onchange="cal8()"  style="width:100px;" value="<?php echo $E93; ?>"   maxlength="100" /> </td>
            <td><input type="text" id="datepicker31"  name="E94" onchange="cal8()"  style="width:100px;" value="<?php echo $E94; ?>"  maxlength="100" /> </td>
            <td><input type="text" class="textbox" id="numdays8" name="E95" style="width:150px;" value="<?php echo $E95; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="10" name="E96"  style="width:100px;" value="<?php echo $E96; ?>"   maxlength="100"/> </td>
            <td><input type="text" size="10" name="E97"  style="width:100px;" value="<?php echo $E97; ?>"  maxlength="100" /> </td>
            
            <!-- <td><input type="text> <input type="submit" value="Update" name="submit_update_2"></td> -->
            <!-- <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        </tr>
         <tr>
            <td><input type="text" size="30" name="E101" value="<?php echo $E101; ?>"  maxlength="100" /> </td>
            <td><input type="text" size="30" name="E102" value="<?php echo $E102; ?>"  maxlength="100" /> </td>
            <td><input type="text" id="datepicker32" name="E103" onchange="cal9()"  style="width:100px;" value="<?php echo $E103; ?>"   maxlength="100" /> </td>
            <td><input type="text" id="datepicker33" name="E104" onchange="cal9()"  style="width:100px;" value="<?php echo $E104; ?>"   maxlength="100" /> </td>
            <td><input type="text" class="textbox" id="numdays9" name="E105"  style="width:150px;" value="<?php echo $E105; ?>"  maxlength="100" /></td>
            <td><input type="text" size="10" name="E106"  style="width:100px;" value="<?php echo $E106; ?>"   maxlength="100" /> </td>
            <td><input type="text" size="10" name="E107"  style="width:100px;" value="<?php echo $E107; ?>"  maxlength="100" /> </td>
 ...
 <hr>      
     ...
     <br><br>                      <table>
       ...
       <td align="left">
        ...
        <td>
            <input name="teachingexp" type="text"  size="25" maxlength="150" value="<?php echo $teachingexp; ?>"/>
       ...
       <td>&nbsp;&nbsp;&nbsp;</td>
        <td>
          <input name="researchexp" type="text"  size="25" maxlength="150" value="<?php echo $researchexp; ?>" />
    ...
    <td>&nbsp;&nbsp;&nbsp;</td>
       <td align="left">
        ...
        <td>
          <input name="industryexp" type="text" maxlength="100" maxlength="150" size="25" value="<?php echo $industryexp; ?>" />

       </td>
    </tr>
</table>
<hr>  
<p><b>12. Teaching Experience (Number of Years and/or months) :</b>
...
<hr>      
<p><b>13. Subjects Taught (Last 4 years)</b> 
   <br><br>
 <table  width="60%" style="text-align: center">
 <thead>
...
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
        ...
        <td>
          <input name="cj1" type="text" maxlength="150" size="25" value="<?php echo $_POST['cj1']; ?>" />
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
        <td align="right">
          <p>Ph.D.</p>
        ...
        <td>
          <input name="oj1" type="text" maxlength="150" size="25"  value="<?php echo $_POST['oj1']; ?>"/>
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
       </td>
    </tr>
       ...
       <td align="right">
        ...
        <td>
          <input name="cj2" type="text" maxlength="150" size="25"  value="<?php echo $_POST['cj2']; ?>"/>
        ...
        <td>
          <input name="oj2" type="text" maxlength="150" size="25"  value="<?php echo $_POST['oj2']; ?>"/>
...
<hr>   
     ...
     <thead>
         <tr><td>Author </td> <td>Title</td> <td>Journal</td> <td>Volume</td> <td>Pages </td> <td>Year <br> MM/DD/YYYY</td> <td>Paper Link </td> <td>&nbsp;</td> <td>&nbsp;</td>  <td>&nbsp;</td> <td>&nbsp;</td> </tr>
    </thead>
    <tbody>
     <tr>
           <td><input type="text"  maxlength="150" size="20" name="E3_11" value="<?php echo $E3_11; ?>"  /> </td>
            <td><input type="text"  maxlength="150" size="30" name="E3_12" value="<?php echo $E3_12; ?>"  /> </td>
          
 <td>
            <label for="E3_13"></label>
            <input type="text"  maxlength="150"  size="20"   name="E3_13" value="<?php echo $E3_13; ?>"  ></td>

          <!--  <td><input type="text"   maxlength="150" size="20" name="E3_13" value="<?php echo $E3_13; ?>"  /> </td> -->
            <td><input type="text"  maxlength="150" size="20" name="E3_14" value="<?php echo $E3_14; ?>"  /></td>
            <td><input type="text"  maxlength="150" size="10" name="E3_15" value="<?php echo $E3_15; ?>"  /> </td>
            <td><input type="text"  maxlength="150" id="datepicker34"   name="E3_16" value="<?php echo $E3_16; ?>"  /></td>
            <td><input type="text"   maxlength="150"  name="E3_17" value="<?php echo $E3_17; ?>"  /></td>
        ...
        <tr>
          <td><input type="text"  maxlength="150" size="20" name="E3_21" value="<?php echo $E3_21; ?>"  /> </td>
            <td><input type="text"  maxlength="150" size="30" name="E3_22" value="<?php echo $E3_22; ?>"  /> </td>
 <td>
            <label for="E3_23"></label>
            <input type="text"  maxlength="150"  size="20"  name="E3_23" value="<?php echo $E3_23; ?>"  ></td>

<!--            <td><input type="text"  maxlength="150" size="20" name="E3_23" value="<?php echo $E3_23; ?>"  /> </td> -->
            <td><input type="text"  maxlength="150" size="20" name="E3_24" value="<?php echo $E3_24; ?>"  /></td>
            <td><input type="text"  maxlength="150" size="10" name="E3_25" value="<?php echo $E3_25; ?>"  /> </td>
            <td><input type="text"   maxlength="150" id="datepicker35" name="E3_26" value="<?php echo $E3_26; ?>"  /></td>
            <td><input type="text"   maxlength="150"  name="E3_27" value="<?php echo $E3_27; ?>"  /></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        ...
        <tr>
        <td><input type="text"  maxlength="150" size="20" name="E3_31" value="<?php echo $E3_31; ?>"  /> </td>
            <td><input type="text"  maxlength="150" size="30" name="E3_32" value="<?php echo $E3_32; ?>"  /> </td>

<td>
            <label for="E3_33"></label>
            <input type="text"  maxlength="150"  size="20"   name="E3_33"  value="<?php echo $E3_33; ?>"></td>

<!--            <td><input type="text"  maxlength="150" size="20" name="E3_33" value="<?php echo $E3_33; ?>"  /> </td>-->
            <td><input type="text"  maxlength="150" size="20" name="E3_34" value="<?php echo $E3_34; ?>"  /></td>
            <td><input type="text"  maxlength="150" size="10" name="E3_35" value="<?php echo $E3_35; ?>"  /> </td>
            <td><input type="text"  maxlength="150" id="datepicker36"  name="E3_36" value="<?php echo $E3_36; ?>"  /></td>
            <td><input type="text"  maxlength="150"  name="E3_37" value="<?php echo $E3_37; ?>"  /></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
                 ...
                 <tr>
           <td><input type="text"  maxlength="150" size="20" name="E3_41" value="<?php echo $E3_41; ?>"  /> </td>
            <td><input type="text"  maxlength="150" size="30" name="E3_42" value="<?php echo $E3_42; ?>"  /> </td>

            <td>
		<label for="E3_43"></label>
		<input type="text"  maxlength="150" size="20"  name="E3_43" value="<?php echo $E3_43; ?>"  /> </td>
            <td><input type="text"  maxlength="150" size="20" name="E3_44" value="<?php echo $E3_44; ?>"  /></td>
            <td><input type="text"  maxlength="150" size="10" name="E3_45" value="<?php echo $E3_45; ?>"  /> </td>
            <td><input type="text"  maxlength="150" id="datepicker37"  name="E3_46" value="<?php echo $E3_46; ?>"  /></td>
           <td><input type="text"   maxlength="150"  name="E3_47" value="<?php echo $E3_47; ?>"  /></td>
...
<br><br>
<textarea name="BInternational"  style="width: 800px; height: 50px;" rows="" maxlength="1000" cols="200"  > <?php echo $BInternational; ?> </textarea> 

        <hr>  
        <br>
         <b>17. Patents(applied or awarded) </b> 
    <br>
         <textarea name="patents" style="width: 800px; height: 50px;"rows="4" maxlength="1000" cols="100" ><?php echo $_POST['patents']; ?></textarea>
...
<hr>      
<p align="center" width="80%"><input id="btn1" type="submit" formaction="eq32page.php" value="Save Progress" name="previous">               </p>    
<hr>      
...
<hr>
   <b>22. Industrial Experience or R&D lab / Interaction (Upload photocopies)  </b> <br><br>
    ...
    <tr>
        <td><input type="text" name="ie11" maxlength="150" value="<?php echo $ie11; ?>"  /> </td>
        <td><input type="text" maxlength="150" name="ie12"  value="<?php echo $ie12; ?>"  /> </td>
        <td><input type="text" name="ie13"  maxlength="150" value="<?php echo $ie13; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie21" maxlength="150" value="<?php echo $ie21; ?>"  /></td>
        <td><input type="text" maxlength="150" name="ie22"  value="<?php echo $ie22; ?>"  /></td>
        <td><input type="text" name="ie23" maxlength="150" value="<?php echo $ie23; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie31" maxlength="150"  value="<?php echo $ie31; ?>"  /></td>
        <td><input type="text" maxlength="150"  name="ie32"  value="<?php echo $ie32; ?>"  /> </td>
        <td><input type="text" name="ie33" value="<?php echo $ie33; ?>"  /> </td>

    </tr>
    <tr>
        <td><input type="text" name="ie41" maxlength="150" value="<?php echo $ie41; ?>"  /></td>
        <td><input type="text" name="ie42" maxlength="150" value="<?php echo $ie42; ?>"  /></td>
        <td><input type="text" name="ie43" maxlength="150" value="<?php echo $ie43; ?>"  /></td>
    </tr>
    <tr>
        <td><input type="text" name="ie51" maxlength="150" value="<?php echo $ie51; ?>"  /></td>
        <td><input type="text" name="ie52" maxlength="150" value="<?php echo $ie52; ?>"  /></td>
        <td><input type="text" name="ie53" maxlength="150" value="<?php echo $ie53; ?>"  /></td>

    </tr>
    <tr>
       <td><input type="text" name="ie61" maxlength="150" value="<?php echo $ie61; ?>"  /></td>
       <td><input type="text" name="ie62" maxlength="150" value="<?php echo $ie62; ?>"  /></td>
       <td><input type="text" name="ie63" maxlength="150" value="<?php echo $ie63; ?>"  /></td>
    </tr>
    <tr>
        <td><input type="text" name="ie71" maxlength="150" value="<?php echo $ie71; ?>"  /></td>
        <td><input type="text" name="ie72" maxlength="150" value="<?php echo $ie72; ?>"  /></td>
        <td><input type="text" name="ie73" maxlength="150" value="<?php echo $ie73; ?>"  /></td>

    </tr>
    <tr>
        <td><input type="text" name="ie81" maxlength="150" value="<?php echo $ie81; ?>"  /></td>
        <td><input type="text" name="ie82" maxlength="150" value="<?php echo $ie82; ?>"  /></td>
        <td><input type="text" name="ie83"  maxlength="150" value="<?php echo $ie83; ?>"  /></td>

    </tr>
    <tr>
        <td><input type="text" name="ie91" maxlength="150" value="<?php echo $ie91; ?>"  /></td>
        <td><input type="text" name="ie92"  maxlength="150" value="<?php echo $ie92; ?>"  /></td>
        <td><input type="text" name="ie93" maxlength="150" value="<?php echo $ie93; ?>"  /></td>

    </tr>
    <tr>
        <td><input type="text" name="ie101" maxlength="150" value="<?php echo $ie101; ?>"  /></td>
         <td><input type="text" name="ie102" maxlength="150"  value="<?php echo $ie101; ?>"  /></td>
        <td><input type="text" name="ie103" maxlength="150" value="<?php echo $ie103; ?>"  /></td>
 </tr>
</table>                    
 <hr> 
...
<tr><td >2.&nbsp;&nbsp;&nbsp;<input type="text" style="width: 300px;" maxlength="200" name="pr21"  ></td></tr>
 ...
 <textarea name="expcomp" style="width: 800px; height: 50px;"  rows="" maxlength="1000" cols="200"  ><?php echo $_POST['expcomp']; ?></textarea>
    <hr>   

      <b> M.Tech., M..Sc. or B.Tech project supervision on live industrial problems. </b> 
    <br><br><br>
    <textarea name="live" style="width: 800px; height: 50px;"  rows="" maxlength="1000"  cols="200"  ><?php echo $_POST['live']; ?></textarea>        
<hr> 
