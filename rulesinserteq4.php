...
if(!$user_home->is_logged_in())
{
  ...
  $nexap = mysqli_real_escape_string($link, $_POST['nexap']);
    $nexap1 = mysqli_real_escape_string($link, $_POST['nexap1']);
     ...
     $sql  = "SELECT * FROM  newrules4 WHERE email='$UID' and appn='$nappn' ";
     $result =  mysqli_query($link, $sql);
$num_rows = mysqli_num_rows($result);
if($num_rows > 0)
{
    $sql="UPDATE newrules4  SET name='$name', dept='$dept', Inst='$Inst', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
{    
$sql = "insert into newrules4 values('$name', '$dept', '$Inst', '$loneproj', '$teamproj', '$coproj', '$patgrant', '$consult', '$loneguide',
...
<style>
   ...
   <div class="navbar navbar-fixed-top ">
       ...
       <form action="eq4page.php" method="post" name="f1" >
     <hr>
     <table>
          <tr>
    ...
    <?php $_SESSION['credit1']=$credit1; ?>     
      ...
      <table>
          <tr>
                    ...
                    <th>  <p> Department Name:<input type="text"  name="dept" value="<?php echo $dept; ?> " /> </p></th>
                    <th>  <p>Current Institute Name:<input type="text"  name="Inst" value="<?php echo $Inst; ?> " /> </p></th>
            </tr>
      </table>
      <hr>  
...
<table CELLPADDING=10 cellspacing="10" >
 <tr>
 <p> <b>    10. Workshops/FDP/Short term courses of minimum 05 working days duration offered as coordinator or convenor - Number (since last promotion)(Upload the cerficates):</b> </p></tr>
...
<table colspan="10"> 
             ...
             <tr><td>Total working experience:</td><td><input type="text" maxlength="100" size="10" id="nexpg" name="nexpg"  value="<?php echo $nexpg ?>" style="width:100px;" required></td><td><input type="text" maxlength="100" size="10" id="nexpg1" name="nexpg1"  value="<?php echo $nexpg1 ?>" required  style="width:100px;"><td> </tr>
         ...
         <tr><td>Experience at the level of Assistant Professor(AGP:8000) or equivalent :<td> <input type="text" maxlength="100" size="10"  id="nexap" name="nexap"  value="<?php echo $nexap ?>" style="width:100px;" required></td><td> <input type="text" maxlength="100" size="10" id="nexap1" name="nexap1"  value="<?php echo $nexap1 ?>" required style="width:100px;"><td> </tr>
         
         </table> 
 <hr>
<!--<br> <b>number of score is </b>: <br>-->
<center>   <input type="submit" id="btn1" formaction="eq4page.php" value="Submit Credit Points" name="save">  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" id="btn1" formaction="rulesinserteq4.php" value="Calculate Credit" name="SubmitButton"> </center>
