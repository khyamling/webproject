...
//Strong liaison with industry; Offering courses through application of ICT. 
       ...
       $respos = mysqli_real_escape_string($link, $_POST['respos']);

 $sql  = "SELECT * FROM  eq6page WHERE email='$UID' and appn='$nappn' ";
...
if( $num_rows > 0)
{
 $sql="UPDATE eq6page SET  Page5= '$Page5', Page6='$Page6', Page7='$Page7', Page8='$Page8',Page11='$Page11', Page12='$Page12',
         Page17='$Page17', Page18='$Page18', Page19='$Page19', Page22='$Page22', Page23='$Page23', Page24='$Page24', 
         Page25='$Page25', Page26='$Page26', Page27='$Page27', Page28='$Page28', Page29='$Page29', Page30='$Page30', 
         Page31='$Page31', Page32='$Page32', Page33='$Page33', Page34='$Page34', Page35='$Page35', Page36='$Page36',
         Page37='$Page37', Page38='$Page38', Page41='$Page41', Page42='$Page42', Page43='$Page43', Page44='$Page44',
         Page45='$Page45', Page46='$Page46', Page47='$Page47', Page48='$Page48', Page49='$Page49',
...
teachingexp='$teachingexp', researchexp='$researchexp', industryexp='$industryexp',
asstprof='$asstprof',  assoprofexp='$assoprofexp',profexp='$profexp',
...
$sql = "insert into eq6page values('$Page5', '$Page6', '$Page7', '$Page8','$Page11', '$Page12', '$Page17',
        '$Page18', '$Page19','$Page22', '$Page23', '$Page24', '$Page25', '$Page26', '$Page27',
         '$Page28', '$Page29','$Page30', '$Page31', '$Page32', '$Page33', '$Page34', '$Page35', 
        '$Page36', '$Page37', '$Page38', '$Page41', '$Page42', '$Page43', '$Page44', '$Page45', '$Page46',
        '$Page47', '$Page48', '$Page49',
...
$sql  = "SELECT * FROM  eq6 WHERE email='$UID' and appn='$nappn' ";
	//tmt->execute(array(":emailI=>$email));
...
if( $num_rows > 0)
{
 $sql="UPDATE eq6  SET  ph1='$ph1', ph2='$ph2', ph3='$ph3', ph4='$ph4', ph5='$ph5', ph6='$ph6', ph7='$ph7', ph8='$ph8',
...
F51='$F51', F52='$F52', F53='$F53', F54='$F54',BInternational='$BInternational'  WHERE appn='$nappn' ";
...
'$expcomp', '$respos','$BInternational','$nappn', '$UID')";
...
<div class="navbar navbar-fixed-top">
 ...
 <li><a href="submit.php">Submit/Print Application</a></li>
        ...
        <form action="eq6pageinsert.php" method="post" name="f1" >
        <hr>
                <table>
          <tr>
...
<td><input type="text" id="e17" maxlength="11" name="e17" onChange="perc1()" value="<?php echo $_POST['e17']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e18" id="e18" maxlength="10"  value="<?php echo $_POST['e18']; ?>" ></td>
...
<td><input type="text" id="e27" maxlength="11" name="e27" onChange="perc2()" value="<?php echo $_POST['e27']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e28" id="e28" maxlength="10"  value="<?php echo $_POST['e28']; ?>" ></td>
...
<td><input type="text" id="e37" maxlength="11" name="e37" onChange="perc3()" value="<?php echo $_POST['e37']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e38" id="e38"  maxlength="10"  value="<?php echo $_POST['e38']; ?>" ></td>
...
<td><input type="text" id="e47" maxlength="11" name="e47" onChange="perc4()" value="<?php echo $_POST['e47']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e48" id="e48" maxlength="10"  value="<?php echo $_POST['e48']; ?>" ></td>
...
<td><input type="text" id="e57" maxlength="11" name="e57" onChange="perc5()" value="<?php echo $_POST['e57']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e58" id="e58" maxlength="10"  value="<?php echo $_POST['e58']; ?>" ></td>
...
<td><input type="text" id="e77" maxlength="11" name="e77" onChange="perc7()" value="<?php echo $_POST['e77']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e78" id="e78"  maxlength="10"  value="<?php echo $_POST['e78']; ?>" ></td>
...
<td><input type="text" id="e87" maxlength="11" name="e87" onChange="perc8()" value="<?php echo $_POST['e87']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e88" id="e88" maxlength="10"  value="<?php echo $_POST['e88']; ?>" ></td>
...
<td><input type="text" id="e97" maxlength="11" name="e97" onChange="perc9()" value="<?php echo $_POST['e97']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e98" id="e98" maxlength="10"  value="<?php echo $_POST['e98']; ?>" ></td>
...
<td><input type="text" id="e107" maxlength="11" name="e107" onChange="perc10()" value="<?php echo $_POST['e107']; ?>" ></td>
         <!--for pecentage -->
        <td><input type="text" name="e108"  id="e108" maxlength="10"  value="<?php echo $_POST['e108']; ?>" ></td>
...
<td><input type="text" name="nt13" class="form-control" size="50" value="<?php echo $_POST['nt13']; ?>" maxlength="150"> </td> 
 ...
 <option>  <?php if(!($_POST['nt52']=="")) { echo $_POST['nt52'] ?> <?php } else { ?> - Year - <?php } ?> </option>
  ...
  <hr>      
<p align="center" width="80%">        <input type="submit" formaction="eq61page.php" value="Save Progress" name="previous">               </p>    
<hr>      <p>
    ...
    <table border="0" cellpadding="0" cellspacing="5">
     <tr>
       ...
       <td align="right">
        ...
        <td>
          <input name="profexp" type="text" maxlength="150" size="25" value="<?php echo $profexp; ?>" />
...
<!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
 ...
 <td>
            ...
            <input type="text"  maxlength="150"  size="20"  id="E3_13" name="E3_13" value="<?php echo $E3_13; ?>"  ></td>
...
<!--            <td><input type="text" maxlength="150" size="20" name="E3_13" value="<?php echo $E3_13; ?>"  /> </td> -->
 ...
 <td>
            ...
            <input type="text"  maxlength="150"  size="20" id="E3_23" name="E3_23" value="<?php echo $E3_23; ?>"  ></td>
...
<td>
            ...
            <input type="text"  maxlength="150"  size="20"  id="E3_33" name="E3_33"  value="<?php echo $E3_33; ?>"></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
           ...
           <td><input type="text" maxlength="150" size="20" name="E3_41" value="<?php echo $E3_41; ?>"  /> </td>
            ...
            <td><input type="text" maxlength="150" size="20" name="E3_43" value="<?php echo $E3_43; ?>"  /> </td>
...
<hr>   
<p align="center" width="80%">        <input type="submit" formaction="eq62page.php" value="Save Progress" name="previous"> </p>   
<hr>      
...
<tr><td >2.&nbsp;&nbsp;&nbsp;<input type="text" style="width: 300px;" maxlength="200" name="pr21"  ></td></tr>
 ...
 <tr>
   ...
   <b>28. Please indicate how in your opinion you can contribute to NITK's growth. (upload relevant document)
     </b><br><br>    <textarea style="width: 800px; height: 50px;" name="ao1" maxlength="1000"  placeholder="Limited to 250 words" >
    </textarea>
...
<p width="80%" style="width:80%">   <b>
    ...
    <table  align="center" width="40%"> 
        <tr>
 <hr>    
     <b> Three experiments or computational projects added to teaching laboratories.</b><br><br>
    <textarea name="expcomp" style="width: 800px; height: 50px;" rows=""  maxlength="1000" cols="200"  ><?php echo $_POST['expcomp']; ?></textarea>
     ...
     <br> <br>
     <textarea name="respos" style="width: 800px; height: 50px;"  rows="" maxlength="1000" cols="200"  ><?php echo $_POST['respos']; ?></textarea>
 
     <hr>
29. </b>I hereby declare that the entries in this form are true to the best of my knowledge and belief. I understand that my Candidature will be cancelled if any of the information is found to be false or incorrect. Further, if selected, I will abide by
