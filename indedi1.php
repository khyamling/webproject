   ...
   <option value="1946">1946</option>
    ...
    <option value="1939">1939</option>
        ...
        <td><input type="text" maxlength="20" name="e105" style="width:120px;" ></td>
         ...
         <!--for pecentage -->
        <td><input type="text" name="108" id="e108" maxlength="10"  value="" style="width:80px;" ></td>
...
<b>15. a. Publication details - No. of Papers </b> 
   ...
   <tr> 
            ...
            <p>International</p>
                        ...
                        <td>
                        <input name="JInternational" type="text" maxlength="150" size="25" value=""  />
            ...
            <p>International</p>
                        ...
                        <td>
                        <input name="CInternational" type="text" maxlength="150" size="25" value=""  />
                ...
                <tr> 
                        ...
                        <p>National</p>
                            ...
                            <td>
                        <input name="JNational" type="text" maxlength="150" size="25" value=""  />
    <!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
                       </td>
                       <td align="left">
                        <p>National</p>
                            ...
                            <td>
                        <input name="CNational" type="text" maxlength="150" size="25" value=""  />
    <!--         <font color="orangered" size="+1"><tt>*</tt></font>-->
                       </td>
                    </tr>    
    ...
    <tbody>
        <tr>
           <td><input type="text" maxlength="150" size="20" name="E3_11" value=""  /> </td>
            <td><input type="text" maxlength="150" size="30" name="E3_12" value=""  /> </td>

            <td>             
            <label for="E3_13"></label>
            <input type="text"  maxlength="150"  size="20"  id="E3_13" name="E3_13" value=""  ></td>
            
            <!-- <td><input type="text" maxlength="150" size="20" name="E3_13" value=""  /> </td> -->
            <td><input type="text" maxlength="150" size="20" name="E3_14" value=""  /></td>
            <td><input type="text" maxlength="150" size="10" name="E3_15" value=""  /> </td>
            <td><input type="text" maxlength="150"  name="E3_16" value=""  /></td>
            <td><input type="text" maxlength="150"  name="E3_17" value=""  /></td>
        ...
        <tr>
          <td><input type="text" maxlength="150" size="20" name="E3_21" value=""  /> </td>
            <td><input type="text" maxlength="150" size="30" name="E3_22" value=""  /> </td>
           <td>             
            <label for="E3_23"></label>
            <input type="text"  maxlength="150"  size="20" id="E3_23" name="E3_23" value=""  ></td>
             
 	    
           <!--  <td><input type="text" maxlength="150" size="20" name="E3_23" value=""  /> </td> -->
            <td><input type="text" maxlength="150" size="20" name="E3_24" value=""  /></td>
            <td><input type="text"  maxlength="150" size="10" name="E3_25" value=""  /> </td>
            <td><input type="text"  maxlength="150" name="E3_26" value=""  /></td>
            <td><input type="text"  maxlength="150"  name="E3_27" value=""  /></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
        ...
        <tr>
        <td><input type="text" maxlength="150" size="20" name="E3_31" value=""  /> </td>
            <td><input type="text"  maxlength="150" size="30" name="E3_32" value=""  /> </td>
           <!-- <input type="text" maxlength="150" size="20" name="E3_33" value=""  /> </td> -->
 <td>             
            <label for="E3_33"></label>
            <input type="text"  maxlength="150"  size="20" id="E3_33" name="E3_33" value=""  ></td>
          
            <td><input type="text" maxlength="150" size="20" name="E3_34" value=""  /></td>
            <td><input type="text" maxlength="150" size="10" name="E3_35" value=""  /> </td>
            <td><input type="text" maxlength="150"  name="E3_36" value=""  /></td>
            <td><input type="text" maxlength="150"  name="E3_37" value=""  /></td>
...
<!--            <td><input type="submit" value="Delete" name="submit_delete_2"></td> -->
     ...
     <table>
        <tr>
           <td><input type="text" maxlength="150" size="20" name="E3_41" value=""  /> </td>
            <td><input type="text"  maxlength="150" size="30" name="E3_42" value=""  /> </td>
<td>
     <label for="E3_43"></label>
            <input type="text" maxlength="150" size="20" id="E3_43" name="E3_43" value=""  /> </td>

            <td><input type="text" maxlength="150" size="20" name="E3_44" value=""  /></td>
            <td><input type="text" maxlength="150" size="10" name="E3_45" value=""  /> </td>
            <td><input type="text" maxlength="150" name="E3_46" value=""  /></td>
           <td><input type="text"  maxlength="150" name="E3_47" value=""  /></td>
