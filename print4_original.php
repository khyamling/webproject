...
$link = mysqli_connect("localhost", "root", "123html2pdf", "employment");
 ...
 //$res =  mysqli_query($link, $sql);
    ...
    $msg="<table border='1'><tr><th colspan='21'> <center><b>FACULTY RECRUITMENT UNDER 4-TIER FLEXIBLE FACULTY STRUCTURE</b> </center></td></tr>";
    $var="";
    echo $msg;
    $msg=" <tr><th colspan='21'><b> Dept. of ".$dept." </b> <br/><b>  Essential Requirement for The Post of ".$pop." </b></th ></tr>";
    echo $msg;
   $msg="<tr>  <b><th rowspan='2'>Sl. No.</th > <th rowspan='2'> Appn. No. </th ><th  style='width:350px' rowspan='2'> Candidate Name </th ><th rowspan='2'>Email </th ><th rowspan='2'>Mobile No.</th > <th rowspan='2'>Category</th ><th rowspan='2'>PWD</th ><th colspan='2'> % of Ag  </th ><th colspan='4'>Specialization</th ><th >Esss Req</th ><th >Add Req</th ><th rowspan='2' >Area of Specialization</th ><th rowspan='2' >Institute</th ><th>Teaching experience  </th ><th>Research experience </th ><th>Industry experience  </th ><th>Total credits </th > </b></tr>";
    echo $msg;
    ...
    $sql="SELECT * FROM postapplied a JOIN $eq b ON a.appid=b.appn JOIN $eq1 c ON a.appid=c.appn JOIN crediteq1 d ON a.appid=d.appn ";
   // $res = mysql_query($sql);
     $res =  mysqli_query($link, $sql);
     $row=$res->fetch_array();
$cc=1;
    ...
    while($row=mysqli_fetch_array($res))  //fetch all the row as array
    {
        ...
        $b= substr($vapn, 3, 3);
        if($pp==$b && $pp1==$p && $row['status']!=$n){
         $msg="<tr><td>".$cc."</td><td>".$row['appid']."</td><td style='width:350px'>".$row['Page5']."</td><td>".$row['email']."</td><td>".$row['Page34']."</td><td>".$row['Page12']."</td><td>".$row['Page19']."</td><td>".$row['percentage3']."</td><td>".$row['percentage4']."</td><td>".$row['cer3']."</td><td>".$row['cer4']."</td><td>".$row['ph7']."</td><td>".$row['ph3']."</td><td>".$row['credit1']."</td><td>".$row['JInternational']."</td><td>".$row['Page49']."</td><td>".$row['ph4']."</td><td>".$row['teachingexp']."</td><td>".$row['researchexp']."</td><td>".$row['industryexp']."</td><td>".$row['credit1']."</td></tr>";
        echo $msg;      
        $cc=$cc+1;
        }
    ...
    header('Pragma: no-cache');
    header('Content-Type: application/x-msexcel; charset=windows-1251; format=attachment;');
    $msg="<table border='1'><tr><th colspan='31'> <center><b>FACULTY RECRUITMENT UNDER 4-TIER FLEXIBLE FACULTY STRUCTURE</b> </center></td></tr>";
    $var="";
    echo $msg;

    $msg=" <tr><th colspan='31'><b> Dept. of ".$dept." </b> <br/><b>  Essential Requirement for The Post of ".$pop." </b></th ></tr>";
    echo $msg;
     $msg="<tr><b><th style='width: 200px;' rowspan='4'>Sl. No.</th > <th rowspan='4'> Appn. No. </th ><th  style='width:350px' rowspan='4'> Candidate Name </th ><th rowspan='4'>Email </th ><th rowspan='4'>Mobile No.</th ><th rowspan='4'>Category</th ><th rowspan='4'>PWD</th ><th colspan='2'> % of Aggregate  </th ><th colspan='4'>Specialization</th >"
            ."<th colspan='2'>Cumulative Essential <br> Credit Points</th> <th colspan='3'> Essential Requirements <br> Relevant Experience (Year-Months-Days)</th> <th colspan='5'>Other Ess. Req.</th > <th>Add. Desi. Req.</th >  <th rowspan='4'>status</th ><th rowspan='2' >Area of Specialization</th ><th rowspan='2' >Institute</th ><th>Teaching experience  </th ><th>Research experience </th ><th>Industry experience  </th ><th>Total credits </th >  </b></tr>";
    echo $msg;
 
    $msg="<tr> <th rowspan='3'>B.Tech</th > <th rowspan='3'>M.Tech</th ><th rowspan='3'>B.Tech</th > <th rowspan='3'>M.Tech</th ><th rowspan='3'>Ph.D</th ><th rowspan='3'>Ph.D Viva Date</th><th rowspan='3'>credit Points</th><th rowspan='3'>credit Met/Not Met</th> <th rowspan='3'>After Master </th> <th rowspan='3'>After Ph.D </th> <th rowspan='3'> Total Experience Met/Not Met </th>  <th rowspan='3'> No. of Journals</th><th colspan='4'> Ph.D Guidance </th> <th rowspan='3'> Patents</th></tr>";
...
$crmet="Not Met";
   ...
   echo $year."-".$month."-".$days;
      $msg="<tr><td>".$cc."</td><td>".$row['appid']."</td><td>".$row['Page5']."</td><td>".$row['email']."</td><td>".$row['Page34']."</td><td>".$row['Page12']."</td><td>".$row['Page19']."</td><td>".$row['percentage3']."</td><td>".$row['percentage4']."</td><td>".$row['cer3']."</td><td>".$row['cer4']."</td><td>".$row['ph7']."</td><td>".$row['ph3']."</td><td>".$row['credit1']."</td><td>$crmet</td><td>".$row['nexpg']."(Y)-".$row['nexpg1']."(M)</td><td>".$row['nexphd']."(Y)-".$row['nexphd1']."(M)</td><td>$met</td><td>".$row['JInternational']."</td><td>".$row['phdcomplete']."</td><td>".$row['phdongoing']."</td><td>".$row['cj1']."</td><td>".$row['oj1']."</td><td>".$row['patents']."</td><td>".$row['status']."</td></tr>";
         echo $msg;  }
    /*$msg="<table><tr><td>Sl No</td>";
    for ( $i = 0; $i < $numcolumn; $i++ ) {
        $msg.="";
...
$crmet="Not Met";
           ...
           $msg="<tr><td>".$cc."</td><td>".$row['appid']."</td><td>".$row['Page5']."</td><td>".$row['email']."</td><td>".$row['Page34']."</td><td>".$row['Page12']."</td><td>".$row['Page19']."</td><td>".$row['percentage3']."</td><td>".$row['percentage4']."</td><td>".$row['cer3']."</td><td>".$row['cer4']."</td><td>".$row['ph7']."</td><td>".$row['ph3']."</td><td>".$row['credit1']."</td><td>$crmet</td><td>".$row['nexpg']."(Y)-".$row['nexpg1']."(M)</td><td>".$row['nexphd']."(Y)-".$row['nexphd1']."(M)</td><td>$met</td><td>".$row['JInternational']."</td><td>".$row['phdcomplete']."</td><td>".$row['phdongoing']."</td><td>".$row['cj1']."</td><td>".$row['oj1']."</td><td>".$row['patents']."</td><td>".$row['status']."</td><td>".$row['Page49']."</td><td>".$row['ph4']."</td><td>".$row['teachingexp']."</td><td>".$row['researchexp']."</td><td>".$row['industryexp']."</td><td>".$row['credit1']."</td></tr>";
     echo $msg;      
        $cc=$cc+1;
        }
    ...
    header('Pragma: no-cache');
    header('Content-Type: application/x-msexcel; charset=windows-1251; format=attachment;');
    $msg="<table border='1'><tr><th colspan='36'> <center><b>FACULTY RECRUITMENT UNDER 4-TIER FLEXIBLE FACULTY STRUCTURE</b> </center></td></tr>";
    $var="";
    echo $msg;

    $msg=" <tr><th colspan='36'><b> Dept. of ".$dept." </b> <br/><b>  Essential Requirement for The Post of ".$pop." </b></th ></tr>";
    echo $msg;
    $msg="<tr><b><th style='width: 200px;' rowspan='4'>Sl. No.</th > <th rowspan='4'> Appn. No. </th ><th  style='width:350px' rowspan='4'> Candidate Name </th ><th rowspan='4'>Email </th ><th rowspan='4'>Mobile No.</th ><th rowspan='4'>Category</th ><th rowspan='4'>PWD</th ><th colspan='2'> % of Aggregate  </th ><th colspan='4'>Specialization</th >"
            ."<th colspan='2'>Cumulative Essential <br> Credit Points</th><th colspan='3'> Essential Requirements <br> Relevant Experience (Year-Months-Days)</th> <th colspan='3'> Ess. Requirement</th> <th colspan='7'>Additional Desirable Requirements</th > <th colspan='2'>Other Requirements</th > <th rowspan='4'>status</th ><th rowspan='2' >Area of Specialization</th ><th rowspan='2' >Institute</th ><th>Teaching experience  </th ><th>Research experience </th ><th>Industry experience  </th ><th>Total credits </th >  </b></tr>";
    echo $msg;
 
    $msg="<tr> <th rowspan='3' >B.Tech</th rowspan='3'> <th rowspan='3'>M.Tech</th ><th rowspan='3'>B.Tech</th > <th rowspan='3'>M.Tech</th ><th rowspan='3'>Ph.D</th ><th rowspan='3'>Ph.D Viva Date</th><th rowspan='3'>credit Points</th><th rowspan='3'>credit Met/Not Met</th> <th rowspan='3' >After Master</th> <th rowspan='3'>After Ph.D </th> <th rowspan='3'>Total Experience Met/Not Met</th> <th rowspan='3'>No. Of Journal </th>  <th rowspan='3'>Sponsored Project</th><th rowspan='3'>Experiments/comp. Projects</th><th colspan='4'> Ph.D Guidance </th><th rowspan='3'>Patents</th> <th rowspan='3'>Industrial Exp. or R&D Lab</th> <th rowspan='3'>Live Industry Project</th><th rowspan='3'>Books</th><th rowspan='3'>consult. Project</th></tr>";
...
$crmet="Not Met";
    ...
    echo $year."-".$month."-".$days;
       $msg="<tr><td>".$cc."</td><td>".$row['appid']."</td><td>".$row['Page5']."</td><td>".$row['email']."</td><td>".$row['Page34']."</td><td>".$row['Page12']."</td><td>".$row['Page19']."</td><td>".$row['percentage3']."</td><td>".$row['percentage4']."</td><td>".$row['cer3']."</td><td>".$row['cer4']."</td><td>".$row['ph7']."</td><td>".$row['ph3']."</td><td>".$row['credit1']."</td><td>$crmet</td><td>".$row['nexpg']."(Y)-".$row['nexpg1']."(M)</td><td>".$row['nexphd']."(Y)-".$row['nexphd1']."(M)</td><td>$met</td><td>".$row['JInternational']."</td><td>".$spns."</td><td>".$row['expcomp']."</td><td>".$row['phdcomplete']."</td><td>".$row['phdongoing']."</td><td>".$row['cj1']."</td><td>".$row['oj1']."</td><td>".$row['patents']."</td><td>".$indexp."</td><td>".$row['live']."</td><td>".$row['BInternational']."</td><td>".$cns."</td><td>".$row['status']."</td><td>".$row['Page49']."</td><td>".$row['ph4']."</td><td>".$row['teachingexp']."</td><td>".$row['researchexp']."</td><td>".$row['industryexp']."</td><td>".$row['credit1']."</td></tr>";
         echo $msg; }
    /*$msg="<table><tr><td>Sl No</td>";
    for ( $i = 0; $i < $numcolumn; $i++ ) {
        $msg.="";
