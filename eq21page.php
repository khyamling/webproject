...
//Two papers in SCI Journals or one patent; may be based on Ph.D. work.
        $sci  =  mysqli_real_escape_string($link, $_POST['sci']);
   $nappn=$_POST['nappn'];
//database from advertisement no to areas of specialization
 ...
 $sql  = "SELECT * FROM  eq2page WHERE email='$UID' and appn='$nappn' ";
...
{
$sql = "insert into eq2page values('$Page5', '$Page6', '$Page7', '$Page8','$Page11', '$Page12', '$Page17', '$Page18', '$Page19','$Page22', '$Page23', '$Page24', '$Page25', '$Page26', '$Page27', '$Page28', '$Page29','$Page30', '$Page31', '$Page32', '$Page33', '$Page34', '$Page35', '$Page36', '$Page37', '$Page38', '$Page41', '$Page42', '$Page43', '$Page44', '$Page45', '$Page46', '$Page47', '$Page48', '$Page49',
...
$sql  = "SELECT * FROM  eq2 WHERE email='$UID' and appn='$nappn' ";
	//tmt->execute(array(":emailI=>$email));
...
{
///updating eq1 table 
 $sql="UPDATE eq2  SET  ph1='$ph1', ph2='$ph2', ph3='$ph3', ph4='$ph4', ph5='$ph5', ph6='$ph6', ph7='$ph7', ph8='$ph8',
...
'$E3_41', '$E3_42', '$E3_43', '$E3_44', '$E3_45', '$E3_46', '$E3_47', '$sci', '$nappn', '$UID')";
...
<hr align="left" >      
                 <p align="center">        <input id="btn1" type="submit" formaction="eq21page.php" value="Save Progress" name="previous">               </p>
                   <hr align="left" >      
...
<tr>
            ...
            <td><input type="text"  maxlength="150" size="20" name="E3_42" value="<?php echo $E3_42; ?>" > </td>
           <td>
            <label for="E3_43"></label>
            <input type="text"  maxlength="150"  size="20"  name="E3_43"  value="<?php echo $E3_43; ?>"></td>
            <td><input type="text"  maxlength="150"  size="8" name="E3_44" value="<?php echo $E3_44; ?>" ></td>
           ...
           <td><input type="text"   maxlength="150" size="10"  name="E3_47" value="<?php echo $E3_47; ?>"  /></td>
</tr> 
         </table>
<hr>
 ...
 <hr align="left" >              
    ...
    <br><br>
<textarea name="BInternational"  maxlength="150"  style="width: 800px; height: 50px;" rows="" cols="200"  > <?php echo $BInternational; ?> </textarea> 
    ...
    <textarea  style="width: 800px; height: 50px;"rows="4"  cols="100" name="patents" type="text" maxlength="400" size="25" >
         <?php echo $patents; ?>
    </textarea>
                        <hr align="left" >      
...
<option value="2019">2019</option>
 ...
 <hr> 
 <b>24. Experience in Administrative Positions, Curriculum and Lab Development,  Student Welfare, Professional and Outreach Activities - Non remunerative (upload relevant document)</b> <br><br>
...
<tr><td >2.&nbsp;&nbsp;&nbsp;<input type="text" style="width: 300px;" maxlength="200" name="pr21"  ></td></tr>
 ...
 <tr>
   ...
   <p><b>Additional Desirable requirements</b></p>
     ...
     <br> <br>
      <textarea name="sci" style="width: 800px; height: 50px;"  maxlength="1000" rows="" cols="200"  ><?php echo $_POST['sci']; ?></textarea>   
      </table>
<hr> 
