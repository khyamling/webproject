...
$sql="UPDATE newrules5  SET name='$name', loneproj='$loneproj', teamproj='$teamproj', coproj='$coproj', patgrant='$patgrant', consult='$consult', loneguide='$loneguide',
...
<hr>      
<p align="center" width="80%">        <input id="btn1" type="submit" formaction="eq51page.php" value="Save Progress" name="previous">               </p>    
...
<hr> 
<table>  
 <b> 15.c.Details of conference papers published are to be added in the "Conference Papers" tab. </b>
...
<table style="text-align: center">
 ...
 <hr>      
 <p align="center" width="80%">        <input id="btn1" type="submit" formaction="eq52page.php" value="Save Progress" name="previous">               </p>    
 <hr>      
 <b> 21. Conferences/Seminars / Workshops Conducted (Since last promotion -Upload photocopies of the certificates)as per Gazette Note 1(4)</b>
...
<b>22. Industrial Experience/Interaction (Upload photocopies)  </b> <br><br>
 ...
 <hr> 
 <b>23. Experience in Administrative Positions, Curriculum and Lab Development,  Student Welfare, Professional and Outreach Activities (upload relevant document)as per Gazette Note 1(4)</b> <br><br>
