...
<style>
 ...
 <form action="rulesinserteq3.php" method="post" name="f1" >
      <table  rule="rows">
          <tr> <br><br><br>
       ...
       <hr> 
        <table>
          <tr>
                    ...
                    <th>  <p> Institute Name :<input type="text"  name="Inst" value=" " /> </p></th>
            </tr>
      </table>
       <hr>
...
<tr> <td>   Number of semesters the Dept. level committee positions was held  </td> 
 ...
 <hr>
<table CELLPADDING=10 cellspacing="10" >
    <tr> <p>  <b>10. Workshops/FDP/Short term courses of minimum 05 working days duration offered as coordinator or convenor - Number (since last promotion)(Upload the letter issued by
...
<table CELLPADDING=10 cellspacing="10">
    <tr>
    <p> <b>15. Theory Teaching of over and above 6 credit hrs. course(Since last promotion)(Upload Time table copy scanned officially issued):</b> </p> </tr>
...
Head of the Institution): </b> </p> </tr>
 ...
 <hr>
        ...
        <center>  <input type="submit" id="btn1" formaction="rulesinserteq3.php" value="calculate Credit" name="save"> </center>
