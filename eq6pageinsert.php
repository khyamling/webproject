...
teachingexp='$teachingexp', researchexp='$researchexp', industryexp='$industryexp', asstprof='$asstprof', assoprofexp='$assoprofexp', profexp='$profexp',
...
ie101='$ie101', ie102='$ie102', ie103='$ie103',
...
$xx= "Application Saved successfully. To view application check in view application menu and Application No:" .$nappn; 
                ...
                $xx= " ERROR: Could not able to Save. Try again in View Application " .$nappn.mysqli_error($link); }
}
else
{

$sql = "insert into eq6page values('$Page5', '$Page6', '$Page7', '$Page8','$Page11', '$Page12', '$Page17', '$Page18', '$Page19','$Page22', '$Page23', '$Page24', '$Page25', '$Page26', '$Page27', '$Page28', '$Page29','$Page30', '$Page31', '$Page32', '$Page33', '$Page34', '$Page35', '$Page36', '$Page37', '$Page38', '$Page41', '$Page42', '$Page43', '$Page44', '$Page45', '$Page46', '$Page47', '$Page48', '$Page49', 
...
'$ao1', '$date', '$place','$nappn', '$UID')";
 ...
 if(mysqli_query($link, $sql)){
                ...
                $xx= " ERROR: Could not able to Save. Try again in View Application " .$nappn.mysqli_error($link);
                //echo  " ERROR: Could not able to Save. Try again in View Application " .mysqli_error($link);
...
F51='$F51', F52='$F52', F53='$F53', F54='$F54',BInternational='$BInternational',
...
fa101='$fa101', fa102='$fa102', fa103='$fa103', expcomp='$expcomp',respos='$respos'
          WHERE appn='$nappn' ";
